...
> 작성일: 2026-08-02 | 버전: 2.0 | 상태: GPT 검수용
...
### 5.2 계산 기준
- **기준**: 수영장이 등록한 전용 커리큘럼 템플릿만 사용 (히든 템플릿 제외)
...
### 수영 성장판
- [ ] 동일 커리큘럼 번호 2회 미만이면 완료 처리 안 되는가
- [ ] 게이지는 수영장 전용 커리큘럼 기준으로만 계산되는가
