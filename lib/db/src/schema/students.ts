...
export const studentsTable = pgTable("students", {
  ...
  parent_phone4: text("parent_phone4"),
  ...
  class_enrolled_at: text("class_enrolled_at"),
  ...
  education_started_at: text("education_started_at"), // DATE column in DB; drizzle maps as text for simplicity; 현재 교육구간 시작일 (NULL=전체 이력이 현재 구간)
