...
if (IS_WORKER) {
  ...
  console.log("[worker] 스케줄러 13개 등록 완료 (backup / parent-link / auto-attendance / push / readonly-trigger / standby-sync / video-expiry / queue-worker / growth-report / growth-report-analysis / growth-report-batch / production-backup-daily)");
