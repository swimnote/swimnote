...
const SWIMNOTE_DEFAULT_TEMPLATES: { levelName: string; templates: string[] }[] = [
  { levelName: "흰색: 물적응·호흡", templates: [
    "오늘은 수영장에 적응하는 시간을 가졌습니다. 처음에는 조금 긴장한 모습이 있었지만 수업이 끝날 때는 웃으면서 참여했습니다. 선생님 설명도 잘 듣고 활동에도 적극적으로 참여했습니다. 좋은 출발을 하고 있습니다.",
    "오늘은 물과 친해지는 활동을 진행했습니다. 물을 피하지 않고 자연스럽게 받아들이는 연습을 했습니다. 처음보다 훨씬 편안하게 움직이는 모습이 보였습니다. 수영장 환경에 잘 적응하고 있습니다.",
    "오늘은 물속에서 걸어보는 연습을 했습니다. 물의 저항을 느끼면서 균형 잡는 연습을 진행했습니다. 겁내지 않고 잘 따라왔습니다. 수업 참여도도 좋았습니다.",
    "오늘은 얼굴에 물 묻히기를 연습했습니다. 물을 피하지 않고 스스로 해보려는 모습이 좋았습니다. 처음보다 훨씬 자연스럽게 적응하고 있습니다. 조금씩 자신감이 생기고 있습니다.",
    "오늘은 얼굴에 물 붓기를 연습했습니다. 얼굴로 물이 흐르는 상황에 적응하는 시간을 가졌습니다. 전보다 훨씬 편안한 모습이었습니다. 긴장이 많이 줄어들었습니다.",
    "오늘은 입술까지 물에 담그는 연습을 했습니다. 물을 무서워하지 않고 차분하게 참여했습니다. 망설이는 시간이 점점 줄어들고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 턱까지 물에 담그는 연습을 했습니다. 얼굴을 물에 가까이하는 연습을 반복했습니다. 처음보다 훨씬 자연스러워졌습니다. 잘 따라오고 있습니다.",
    "오늘은 코까지 물에 담그는 연습을 했습니다. 물을 피하지 않고 스스로 도전하는 모습이 좋았습니다. 전보다 훨씬 편안하게 참여했습니다. 물에 대한 두려움이 줄어들고 있습니다.",
    "오늘은 얼굴 담그기를 시작했습니다. 혼자서도 얼굴을 물속에 넣어보는 연습을 진행했습니다. 생각보다 잘 해주었습니다. 적극적으로 참여하는 모습이 좋았습니다.",
    "오늘은 얼굴 담그기 시간을 늘려보았습니다. 물속에서도 편안하게 있을 수 있도록 연습했습니다. 처음보다 훨씬 안정적인 모습이었습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 얼굴 담그기를 반복 연습했습니다. 망설임 없이 도전하는 모습이 인상적이었습니다. 수업 집중력도 좋아지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 물속에서 눈뜨기를 시작했습니다. 처음에는 어색했지만 끝까지 잘 따라왔습니다. 물속 환경에 적응하려는 모습이 좋았습니다. 좋은 경험이 되었습니다.",
    "오늘은 물속에서 눈뜨기를 연습했습니다. 눈을 감지 않고 주변을 보려고 노력했습니다. 처음보다 훨씬 자연스러워졌습니다. 자신감도 함께 생기고 있습니다.",
    "오늘은 물속에서 물건 찾기를 연습했습니다. 눈을 뜨고 목표를 찾는 활동을 진행했습니다. 재미있게 참여하는 모습이 좋았습니다. 물속 적응이 잘 이루어지고 있습니다.",
    "오늘은 물속에서 물건 찾기를 반복했습니다. 눈뜨기에 대한 부담이 많이 줄었습니다. 스스로 해보려는 모습이 좋았습니다. 적극적으로 참여했습니다.",
    "오늘은 숨 참기를 시작했습니다. 물속에서도 침착하게 기다리는 연습을 했습니다. 생각보다 잘 해주었습니다. 집중력도 좋았습니다.",
    "오늘은 숨 참기 시간을 늘려보았습니다. 조금 더 오래 버텨보는 연습을 진행했습니다. 전보다 여유 있는 모습이었습니다. 잘 적응하고 있습니다.",
    "오늘은 숨 참기를 반복 연습했습니다. 물속에서도 긴장하지 않으려고 노력했습니다. 차분하게 잘 따라왔습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 물속에서 숨 내쉬기를 시작했습니다. 물을 마시지 않고 천천히 내쉬는 연습을 했습니다. 처음 배우는 내용인데도 잘 따라왔습니다. 호흡 기초를 배우고 있습니다.",
    "오늘은 입으로 숨 내쉬기를 연습했습니다. 후~ 하고 길게 내쉬는 연습을 반복했습니다. 호흡이 점점 자연스러워지고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 코로 숨 내쉬기를 연습했습니다. 물속에서도 편안하게 호흡하는 연습을 진행했습니다. 전보다 훨씬 안정적인 모습이었습니다. 잘 따라오고 있습니다.",
    "오늘은 버블 만들기를 연습했습니다. 숨을 내쉬며 거품 만드는 활동을 진행했습니다. 재미있게 참여하는 모습이 좋았습니다. 물을 무서워하지 않고 있습니다.",
    "오늘은 버블을 길게 유지하는 연습을 했습니다. 천천히 숨을 내쉬는 것에 집중했습니다. 호흡 조절이 좋아지고 있습니다. 꾸준히 연습 중입니다.",
    "오늘은 버블 만들기를 반복 연습했습니다. 물을 편안하게 느끼는 것이 목표였습니다. 처음보다 훨씬 자연스러워졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 숨 참기와 숨 내쉬기를 연결하는 연습을 했습니다. 호흡을 자연스럽게 이어가는 연습을 진행했습니다. 전보다 훨씬 좋아진 모습이었습니다. 다음 단계 준비가 잘 되고 있습니다.",
    "오늘은 물안경 착용에 적응하는 시간을 가졌습니다. 물안경을 쓰고도 편안하게 움직이는 연습을 했습니다. 답답해하지 않고 잘 적응했습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 물안경을 벗고 다시 쓰는 연습을 했습니다. 혼자서도 할 수 있도록 반복 연습했습니다. 점점 익숙해지고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 물안경을 착용한 상태로 이동을 연습했습니다. 물속 시야를 확보한 상태에서 활동을 진행했습니다. 전보다 훨씬 편안하게 움직였습니다. 물 적응이 잘 이루어지고 있습니다.",
    "오늘은 물속에서 스스로 이동하는 연습을 했습니다. 벽을 잡지 않고 움직이는 시간을 가졌습니다. 조금씩 자신감이 생기고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 물 적응 과정을 복습했습니다. 지금까지 배운 내용을 다시 확인하는 시간을 가졌습니다. 처음 수업보다 훨씬 편안한 모습이었습니다. 다음 단계를 준비할 수 있는 수준까지 잘 따라왔습니다.",
  ]},
  { levelName: "흰색: 배영", templates: [
    "오늘은 등을 대고 물에 뜨는 연습을 했습니다. 처음에는 긴장했지만 점점 편안하게 누워 있었습니다. 몸에 힘을 빼려고 노력하는 모습이 좋았습니다. 배영을 배우기 위한 준비가 잘 되고 있습니다.",
    "오늘은 누운 자세를 유지하는 연습을 했습니다. 몸이 흔들리지 않도록 균형을 잡아보았습니다. 처음보다 훨씬 안정적인 모습이었습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 배영 자세를 만들어보는 연습을 했습니다. 머리와 몸을 곧게 유지하는 데 집중했습니다. 자세를 이해하려는 모습이 좋았습니다. 잘 따라오고 있습니다.",
    "오늘은 배영 자세를 반복 연습했습니다. 몸이 가라앉지 않도록 자세를 유지했습니다. 전보다 훨씬 편안한 모습이었습니다. 점점 적응하고 있습니다.",
    "오늘은 배영발차기를 시작했습니다. 누운 자세에서 앞으로 이동하는 연습을 진행했습니다. 처음 배우는 동작인데도 잘 따라왔습니다. 열심히 참여했습니다.",
    "오늘은 배영발차기 자세를 연습했습니다. 몸을 곧게 유지하며 발차기에 집중했습니다. 처음보다 훨씬 좋아진 모습이었습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 배영발차기 3m를 연습했습니다. 발차기를 멈추지 않고 이어가는 연습을 했습니다. 스스로 이동하는 모습이 나오고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 배영발차기 5m를 연습했습니다. 리듬을 유지하며 이동하는 연습을 진행했습니다. 전보다 훨씬 안정적이었습니다. 조금씩 거리도 늘어나고 있습니다.",
    "오늘은 배영발차기 7m를 연습했습니다. 중간에 멈추지 않고 가는 연습을 했습니다. 끝까지 해보려는 모습이 좋았습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 배영발차기 10m를 연습했습니다. 발차기를 계속 이어가며 이동했습니다. 생각보다 잘 해주었습니다. 자신감도 생기고 있습니다.",
    "오늘은 배영발차기 리듬을 연습했습니다. 빠르게 차기보다 꾸준히 차는 것에 집중했습니다. 발차기가 점점 부드러워지고 있습니다. 좋은 흐름입니다.",
    "오늘은 배영발차기 거리를 늘리는 연습을 했습니다. 조금 더 멀리 이동하는 것을 목표로 진행했습니다. 전보다 훨씬 오래 이동하고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 배영발차기를 오래 유지하는 연습을 했습니다. 중간에 멈추지 않고 끝까지 이어갔습니다. 지구력이 좋아지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 무릎을 많이 굽히지 않는 연습을 했습니다. 다리 전체를 사용하는 발차기를 연습했습니다. 발차기 모양이 점점 좋아지고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 발끝을 길게 뻗는 연습을 했습니다. 발등을 사용하는 발차기를 배웠습니다. 전보다 훨씬 자연스러워졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 발차기를 연결하는 연습을 했습니다. 한 번 차고 멈추지 않도록 반복했습니다. 리듬감이 좋아지고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 배영발차기 완주를 목표로 연습했습니다. 끝까지 포기하지 않고 최선을 다했습니다. 처음보다 훨씬 성장한 모습입니다. 많이 칭찬해 주셔도 좋겠습니다.",
    "오늘은 배영발차기 자세를 다시 점검했습니다. 몸의 균형과 발차기를 함께 확인했습니다. 안정감이 많이 좋아졌습니다. 잘 따라오고 있습니다.",
    "오늘은 배영발차기 속도를 조절하는 연습을 했습니다. 급하게 차지 않고 일정하게 차는 연습을 진행했습니다. 발차기가 훨씬 부드러워졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 배영발차기로 방향 유지 연습을 했습니다. 한쪽으로 치우치지 않고 가는 연습을 진행했습니다. 몸의 균형이 좋아지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 배영 팔동작을 시작했습니다. 팔을 크게 돌리는 동작을 배워보았습니다. 처음 배우는 내용인데도 집중해서 참여했습니다. 좋은 출발을 했습니다.",
    "오늘은 한팔 배영을 연습했습니다. 팔동작 순서를 익히는 데 집중했습니다. 생각보다 잘 따라왔습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 한팔 배영을 반복 연습했습니다. 물을 뒤로 보내는 감각을 익혀보았습니다. 조금씩 동작이 자연스러워지고 있습니다. 잘 적응하고 있습니다.",
    "오늘은 양팔 배영을 시작했습니다. 양쪽 팔을 번갈아 사용하는 연습을 진행했습니다. 동작 연결이 좋아지고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 양팔 배영을 반복 연습했습니다. 팔동작을 멈추지 않고 이어가는 연습을 했습니다. 전보다 훨씬 자연스러워졌습니다. 꾸준히 발전하고 있습니다.",
  ]},
  { levelName: "흰색: 자유형", templates: [
    "오늘은 자유형 자세를 시작했습니다. 엎드린 상태에서 몸을 길게 만드는 연습을 했습니다. 새로운 자세에도 잘 적응하는 모습이었습니다. 좋은 출발을 했습니다.",
    "오늘은 엎드린 자세를 유지하는 연습을 했습니다. 몸이 흔들리지 않도록 균형을 잡아보았습니다. 처음보다 훨씬 안정적인 모습이었습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형발차기를 시작했습니다. 발차기로 앞으로 이동하는 연습을 진행했습니다. 처음 배우는 동작인데도 열심히 참여했습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 자유형발차기 자세를 연습했습니다. 몸을 곧게 유지하며 발차기에 집중했습니다. 전보다 훨씬 좋아진 모습이었습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 자유형발차기 3m를 연습했습니다. 발차기를 멈추지 않고 이어가는 연습을 했습니다. 조금씩 앞으로 이동하는 모습이 나오고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형발차기 5m를 연습했습니다. 리듬을 유지하며 이동하는 연습을 진행했습니다. 전보다 훨씬 안정적인 모습이었습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 자유형발차기 7m를 연습했습니다. 중간에 멈추지 않고 가는 연습을 했습니다. 끝까지 해보려는 모습이 좋았습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 자유형발차기 10m를 연습했습니다. 발차기를 계속 이어가며 이동했습니다. 생각보다 잘 해주었습니다. 자신감도 생기고 있습니다.",
    "오늘은 자유형발차기 리듬을 연습했습니다. 빠르게 차기보다 꾸준히 차는 것에 집중했습니다. 발차기가 점점 자연스러워지고 있습니다. 좋은 흐름입니다.",
    "오늘은 자유형발차기 거리를 늘리는 연습을 했습니다. 조금 더 멀리 이동하는 것을 목표로 진행했습니다. 지구력도 함께 좋아지고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형발차기를 오래 유지하는 연습을 했습니다. 중간에 멈추지 않고 끝까지 이어갔습니다. 전보다 훨씬 오래 이동하고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 자유형발차기 완주를 목표로 연습했습니다. 끝까지 포기하지 않고 최선을 다했습니다. 처음보다 훨씬 성장한 모습입니다. 많이 칭찬해 주셔도 좋겠습니다.",
    "오늘은 손을 앞으로 길게 뻗는 연습을 했습니다. 몸을 길게 만드는 자세를 반복했습니다. 자세가 점점 좋아지고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 양손 모으기를 연습했습니다. 팔을 귀 옆으로 붙이는 자세를 배웠습니다. 전보다 훨씬 자연스러워졌습니다. 잘 따라오고 있습니다.",
    "오늘은 유선형 자세를 만들었습니다. 수영에서 가장 중요한 기본 자세를 연습했습니다. 몸을 곧게 유지하는 모습이 좋았습니다. 집중력도 좋았습니다.",
    "오늘은 유선형 자세를 유지하는 연습을 했습니다. 자세가 흐트러지지 않도록 반복했습니다. 전보다 훨씬 안정적이었습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 유선형 자세에서 발차기를 연습했습니다. 자세와 발차기를 함께 연결했습니다. 몸의 균형이 좋아지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 글라이딩을 시작했습니다. 벽을 밀고 앞으로 나아가는 연습을 했습니다. 몸을 길게 만드는 것에 집중했습니다. 좋은 출발을 했습니다.",
    "오늘은 글라이딩 거리를 늘리는 연습을 했습니다. 벽을 밀고 최대한 멀리 가보았습니다. 전보다 훨씬 멀리 이동하고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 글라이딩을 반복 연습했습니다. 급하게 움직이지 않고 미끄러져 가는 연습을 했습니다. 몸을 곧게 유지하는 모습이 좋아졌습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형 팔동작을 시작했습니다. 물을 뒤로 보내는 동작을 배워보았습니다. 처음 배우는 내용인데도 집중력이 좋았습니다. 좋은 출발을 했습니다.",
    "오늘은 한팔 자유형을 연습했습니다. 팔동작 순서를 익히는 데 집중했습니다. 물을 잡는 감각을 배우고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 한팔 자유형을 반복 연습했습니다. 팔을 끝까지 사용하는 연습을 진행했습니다. 동작이 점점 자연스러워지고 있습니다. 잘 적응하고 있습니다.",
    "오늘은 양팔 자유형을 시작했습니다. 양쪽 팔을 연결하는 연습을 진행했습니다. 전보다 훨씬 자연스러워졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 양팔 자유형을 반복 연습했습니다. 팔동작을 끊기지 않게 이어가는 연습을 했습니다. 동작 연결이 좋아지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 자유형 팔동작과 발차기를 연결했습니다. 팔과 다리를 함께 사용하는 연습을 진행했습니다. 수영 동작이 점점 완성되고 있습니다. 좋은 흐름입니다.",
    "오늘은 자유형 연결동작을 연습했습니다. 동작이 끊어지지 않도록 반복 연습했습니다. 전보다 훨씬 안정적이었습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형 호흡을 시작했습니다. 고개를 돌려 숨 쉬는 연습을 진행했습니다. 처음에는 어려워했지만 끝까지 도전했습니다. 좋은 경험이 되었습니다.",
    "오늘은 자유형 호흡을 반복 연습했습니다. 호흡 타이밍을 맞추는 것에 집중했습니다. 조금씩 익숙해지고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 자유형 호흡 연결을 연습했습니다. 팔동작과 호흡을 함께 연결했습니다. 전보다 훨씬 자연스러워졌습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 자유형 10m를 연습했습니다. 동작을 연결하며 끝까지 이동했습니다. 혼자 수영하는 모습이 나오고 있습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 자유형 15m를 연습했습니다. 중간에 멈추지 않고 끝까지 이어갔습니다. 체력도 함께 좋아지고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 자유형 20m에 도전했습니다. 배운 동작을 연결하며 완주했습니다. 처음보다 훨씬 안정적인 수영이 나오고 있습니다. 많이 성장한 모습입니다.",
    "오늘은 자유형 완주를 목표로 연습했습니다. 수영 중 자세가 흐트러지지 않도록 집중했습니다. 스스로 수정하려는 모습도 보였습니다. 다음 단계 준비가 잘 되고 있습니다.",
  ]},
  { levelName: "흰색: 평영·접영·레벨업", templates: [
    "오늘은 평영발차기를 시작했습니다. 다리 동작 순서를 하나씩 배우는 시간을 가졌습니다. 처음 배우는 동작인데도 집중해서 참여했습니다. 좋은 출발을 했습니다.",
    "오늘은 평영발차기 자세를 연습했습니다. 다리를 모으고 차는 순서를 반복했습니다. 동작을 이해하려는 모습이 좋았습니다. 잘 따라오고 있습니다.",
    "오늘은 평영발차기 모양을 연습했습니다. 발 모양과 무릎 사용에 집중했습니다. 전보다 훨씬 자연스러워졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 평영발차기를 반복 연습했습니다. 동작 순서를 기억하며 연습을 진행했습니다. 처음보다 훨씬 익숙해지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 평영발차기로 이동하는 연습을 했습니다. 차고 모으는 동작을 연결했습니다. 조금씩 앞으로 나아가는 모습이 보였습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 평영발차기 거리를 늘리는 연습을 했습니다. 동작이 끊어지지 않도록 반복했습니다. 발차기 힘이 점점 좋아지고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 평영발차기를 오래 유지하는 연습을 했습니다. 중간에 멈추지 않고 이어가는 연습을 진행했습니다. 지구력도 함께 좋아지고 있습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 평영발차기 20m에 도전했습니다. 배운 동작을 끝까지 연결해 보았습니다. 생각보다 잘 해주었습니다. 많이 칭찬해 주셔도 좋겠습니다.",
    "오늘은 평영발차기를 점검했습니다. 발차기 모양과 순서를 다시 확인했습니다. 동작 이해도가 많이 좋아졌습니다. 좋은 흐름으로 진행되고 있습니다.",
    "오늘은 접영발차기를 시작했습니다. 몸 전체를 이용하는 발차기를 배웠습니다. 새로운 동작인데도 적극적으로 참여했습니다. 좋은 출발을 했습니다.",
    "오늘은 접영발차기 리듬을 연습했습니다. 상체와 하체를 함께 움직이는 연습을 진행했습니다. 조금씩 감을 잡고 있습니다. 잘 따라오고 있습니다.",
    "오늘은 접영발차기를 반복 연습했습니다. 몸의 움직임을 자연스럽게 연결하는 연습을 했습니다. 전보다 훨씬 좋아진 모습이었습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 접영발차기 자세를 연습했습니다. 리듬이 끊어지지 않도록 반복했습니다. 동작이 점점 자연스러워지고 있습니다. 꾸준히 발전하고 있습니다.",
    "오늘은 접영발차기로 이동하는 연습을 했습니다. 몸의 움직임과 추진력을 연결했습니다. 조금씩 앞으로 나아가는 모습이 보였습니다. 좋은 흐름입니다.",
    "오늘은 접영발차기 거리를 늘리는 연습을 했습니다. 중간에 멈추지 않고 이어가는 연습을 진행했습니다. 전보다 훨씬 안정적인 모습이었습니다. 잘 따라오고 있습니다.",
    "오늘은 접영발차기 20m에 도전했습니다. 끝까지 포기하지 않고 최선을 다했습니다. 노력하는 모습이 정말 좋았습니다. 좋은 경험이 되었습니다.",
    "오늘은 접영발차기를 점검했습니다. 리듬과 자세를 다시 확인하는 시간을 가졌습니다. 처음보다 훨씬 자연스러워졌습니다. 많이 발전한 모습입니다.",
    "오늘은 하얀모자 과정을 복습했습니다. 지금까지 배운 내용을 다시 확인했습니다. 배운 동작들을 잘 기억하고 있었습니다. 레벨업 준비가 잘 되고 있습니다.",
    "오늘은 배영 20m를 점검했습니다. 중간에 멈추지 않고 끝까지 완주했습니다. 자세도 많이 좋아졌습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 자유형 20m를 점검했습니다. 팔, 발, 호흡 연결이 좋아지고 있습니다. 혼자 수영하는 모습이 안정적으로 나오고 있습니다. 자신감도 많이 생겼습니다.",
    "오늘은 평영발차기 20m를 점검했습니다. 동작 순서를 잘 기억하며 수행했습니다. 발차기 모양도 좋아지고 있습니다. 꾸준히 노력한 결과가 보이고 있습니다.",
    "오늘은 접영발차기 20m를 점검했습니다. 리듬을 유지하며 끝까지 이동했습니다. 전보다 훨씬 자연스러운 움직임이 나왔습니다. 좋은 모습을 보여주었습니다.",
    "오늘은 하얀모자 레벨업 테스트를 준비했습니다. 지금까지 배운 내용을 다시 정리하는 시간을 가졌습니다. 긴장하지 않고 차분하게 참여했습니다. 좋은 컨디션으로 준비하고 있습니다.",
    "오늘은 하얀모자 레벨업 테스트를 진행했습니다. 배운 내용을 끝까지 최선을 다해 보여주었습니다. 포기하지 않고 끝까지 해내는 모습이 좋았습니다. 정말 수고 많았습니다.",
    "하얀모자 레벨업을 축하합니다. 처음 시작했을 때보다 정말 많이 성장했습니다. 스스로 해내는 모습이 인상적이었습니다. 파란모자 과정에서도 즐겁게 함께 배우겠습니다.",
  ]},
];
