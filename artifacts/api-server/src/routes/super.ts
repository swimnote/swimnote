...
async function ensurePlansTables() {
  ...
  for (const plan of [
    ...
    { tier: "starter",    plan_id: "solo_30",        name: "Coach 30",     price: 3500,   limit: 30,   storage_gb: 3,          storage_mb: 3072,   display: "3GB"   },
    { tier: "basic",      plan_id: "solo_50",        name: "Coach 50",     price: 6500,   limit: 50,   storage_gb: 5,          storage_mb: 5120,   display: "5GB"   },
    { tier: "standard",   plan_id: "solo_100",       name: "Coach 100",    price: 9500,   limit: 100,  storage_gb: 10,         storage_mb: 10240,  display: "10GB"  },
    // ── Premier (수영장/센터, 사진+영상) ────────────────────────────────────
    { tier: "center_200", plan_id: "center_200",     name: "Premier 200",  price: 69000,  limit: 200,  storage_gb: 50,         storage_mb: 51200,  display: "50GB"  },
