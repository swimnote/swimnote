...
const s = StyleSheet.create({
  ...
  info: { flex: 1, gap: 2 },
  name: { fontSize: 14, fontFamily: "Pretendard-Bold", color: "#111827" },
  sub:  { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#6B7280" },
  sub2: { fontSize: 12, fontFamily: "Pretendard-Regular", color: "#9CA3AF" },
  ...
  rejectNoteText: { flex: 1, fontSize: 12, fontFamily: "Pretendard-Regular", lineHeight: 16 },
  actions: {
    flexDirection: "row",
    gap: 10,
    padding: 12,
  ...
  viewText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  approveBtn: {
    flex: 1, height: 44, flexDirection: "row",
    borderRadius: 10,
    alignItems: "center", justifyContent: "center", gap: 6,
  },
  approveText: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#fff" },
});
