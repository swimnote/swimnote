    ...
    <View style={s.section}>
      ...
      {sessions.map(sess => (
        <View key={sess.id} style={s.sessionRow}>
          <View style={[s.sessionIconBox, { backgroundColor: C.surface }]}>
...
const s = StyleSheet.create({
  ...
  sessionDevice: { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.textPrimary },
  sessionOwner:  { fontSize: 11, fontFamily: "Pretendard-Regular", color: C.textSecondary,
                   backgroundColor: C.surface, borderRadius: 4, paddingHorizontal: 5, paddingVertical: 1 },
  sessionMeta:  { fontSize: 11, fontFamily: "Pretendard-Regular", color: C.textSecondary, marginTop: 2 },
  terminateBtn: { backgroundColor: "#F9DEDA", paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  terminateTxt: { fontSize: 11, fontFamily: "Pretendard-Regular", color: DANGER },
});
