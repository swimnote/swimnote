...
const cc = StyleSheet.create({
  ...
  usageBox:   { gap: 0 },
  usageMain:  { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#0F172A" },
  ...
  metricVal:  { fontSize: 12, fontFamily: "Pretendard-Regular", color: "#0F172A", marginTop: 2 },
    ...
    <View style={dp.container}>
      ...
      {rows.map((r, i) => (
        <View key={i} style={dp.row}>
          ...
          <Text style={[dp.val, r.highlight ? { color: P, fontFamily: "Pretendard-Regular" } : {}]}>
            {r.value ?? "미측정"}
          </Text>
        </View>
      ))}
...
const dp = StyleSheet.create({
  ...
  val:       { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#0F172A", textAlign: "right", flex: 1 },
  closeBtn:  { marginTop: 12, backgroundColor: "#FFFFFF", borderRadius: 10, paddingVertical: 12, alignItems: "center" },
  closeTxt:  { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#0F172A" },
});
...
const svc = StyleSheet.create({
  ...
  name:        { fontSize: 12, fontFamily: "Pretendard-Regular", color: "#0F172A" },
...
const anom = StyleSheet.create({
  ...
  msg: { flex: 1, fontSize: 12, fontFamily: "Pretendard-Regular", lineHeight: 17 },
});
  ...
  if (loading && !summary) {
    return (
      <View style={{ alignItems: "center", paddingVertical: 40, gap: 10 }}>
        ...
        <Text style={{ fontSize: 13, fontFamily: "Pretendard-Regular", color: GRAY }}>인프라 상태 조회 중...</Text>
      </View>
    );
  }
  ...
  if (error && !summary) {
    return (
      <View style={{ alignItems: "center", paddingVertical: 30, gap: 10 }}>
        ...
        <Text style={{ fontSize: 13, fontFamily: "Pretendard-Regular", color: DANGER }}>{error}</Text>
        <Pressable style={{ backgroundColor: "#EEDDF5", borderRadius: 10, paddingHorizontal: 16, paddingVertical: 10 }} onPress={loadAll}>
          <Text style={{ fontSize: 13, fontFamily: "Pretendard-Regular", color: P }}>다시 시도</Text>
        </Pressable>
      </View>
    );
  }
...
const ps = StyleSheet.create({
  ...
  mainTitle:       { fontSize: 16, fontFamily: "Pretendard-Regular", color: "#0F172A" },
  ...
  subTitle:        { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#0F172A", marginBottom: 2 },
});
