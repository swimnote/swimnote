...
const s = StyleSheet.create({
  ...
  scopeTxt:     { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  typeTxt:      { fontSize: 11, fontFamily: "Pretendard-Medium" },
  ...
  dismissTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#64748B" },
  confirmBtn:   { flex: 1, padding: 13, borderRadius: 12,
                  backgroundColor: P, alignItems: "center" },
  confirmTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#fff" },
