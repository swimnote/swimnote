...
const s = StyleSheet.create({
  ...
  title:       { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: "#0F172A", textAlign: "center" },
  ...
  otpBoxTxt:   { fontSize: 22, fontFamily: "Pretendard-SemiBold", color: P },
  ...
  errorTxt:    { fontSize: 12, fontFamily: "Pretendard-Medium", color: DANGER, flex: 1 },
  ...
  successTxt:  { fontSize: 14, fontFamily: "Pretendard-Medium", color: GREEN },
