...
const s = StyleSheet.create({
  ...
  desc: { fontSize: 14, color: "#6F6B68", textAlign: "center", lineHeight: 21 },
  btnRow: { flexDirection: "row", gap: 8, marginTop: 8, width: "100%" },
  cancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 10, borderWidth: 1, borderColor: "#E9E2DD", alignItems: "center" },
  cancelTxt: { fontSize: 14, fontWeight: "600", color: "#6F6B68" },
  confirmBtn: { flex: 1.4, paddingVertical: 12, borderRadius: 10, backgroundColor: "#1F8F86", alignItems: "center" },
