          ...
          {actions?.map((act, i) => (
            ...
            >
              {act.loading ? (
                ...
                <LucideIcon name={act.icon as any} size={12} color={act.color} />
              )}
...
const s = StyleSheet.create({
  ...
  scheduleHintTag: { alignSelf: "flex-start", backgroundColor: C.backgroundSoft, borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  scheduleHintTxt: { fontSize: 10, fontFamily: "Pretendard-Regular", color: C.textSecondary },
