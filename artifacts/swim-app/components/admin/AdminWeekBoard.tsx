...
const wb = StyleSheet.create({
  ...
  dayHeaderText: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: C.text },
  row: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#F8FAFC" },
  ...
  timeText: { fontSize: 10, fontFamily: "Pretendard-Regular", color: C.textMuted },
  cell: { borderLeftWidth: 1, borderLeftColor: "#F8FAFC", padding: 2, gap: 2 },
  classChip: { borderRadius: 5, padding: 3, minHeight: 26, justifyContent: "center" },
  chipName: { fontSize: 8, fontFamily: "Pretendard-SemiBold", color: "#fff", lineHeight: 10 },
  chipCount: { fontSize: 7, fontFamily: "Pretendard-Regular", color: "rgba(255,255,255,0.85)", marginTop: 1 },
  emptyCell: { flex: 1, alignItems: "center", justifyContent: "center" },
  emptyCellText: { fontSize: 16, color: "#E5E7EB", fontFamily: "Pretendard-Regular" },
});
