...
const p = StyleSheet.create({
  ...
  className: { fontSize: 18, fontFamily: "Pretendard-SemiBold", marginBottom: 4 },
  ...
  statVal: { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
  ...
  tabLabel: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  diaryTeacher: { fontSize: 13, fontFamily: "Pretendard-Medium" },
