...
const p = StyleSheet.create({
  ...
  className: { fontSize: 18, fontFamily: "Pretendard-Regular", marginBottom: 4 },
  ...
  statVal: { fontSize: 20, fontFamily: "Pretendard-Regular" },
  ...
  tabLabel: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  ...
  listName: { flex: 1, fontSize: 14, fontFamily: "Pretendard-Regular" },
  ...
  diaryTeacher: { fontSize: 13, fontFamily: "Pretendard-Regular" },
