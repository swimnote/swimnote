...
const sh = StyleSheet.create({
  ...
  headerSub:  { fontSize: 11, fontFamily: "Inter_400Regular", color: C.textMuted, marginTop: 1 },
  ...
  studentSub:   { fontSize: 11, fontFamily: "Inter_400Regular", color: C.textMuted, marginTop: 1 },
  ...
  teacherAvatarText:{ fontSize: 16, fontFamily: "Inter_700Bold" },
  teacherName:    { fontSize: 14, fontFamily: "Inter_600SemiBold", color: C.text },
  teacherSub:     { fontSize: 11, fontFamily: "Inter_400Regular", color: C.textMuted, marginTop: 1 },
});
