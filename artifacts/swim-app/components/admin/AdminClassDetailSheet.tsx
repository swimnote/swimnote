...
const sh = StyleSheet.create({
  ...
  headerTitle:{ fontSize: 16, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  instructorText:{ fontSize: 13, fontFamily: "Pretendard-Medium", color: C.text },
  fullBadge:  { backgroundColor: "#F9DEDA", borderRadius: 6, paddingHorizontal: 8, paddingVertical: 2, marginLeft: 8 },
  fullBadgeText:{ fontSize: 11, fontFamily: "Pretendard-Medium", color: "#D96C6C" },
  ...
  actionBtnText:{ fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#fff" },

  sectionHeader:{ flexDirection: "row", alignItems: "center", justifyContent: "space-between",
                  paddingHorizontal: 16, paddingVertical: 10 },
  sectionTitle: { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
  ...
  studentAvatarText:{ fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.tint },
  ...
  unregBadgeText:{ fontSize: 10, fontFamily: "Pretendard-Medium", color: "#D97706" },
  addBtn:     { backgroundColor: C.tint, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 6,
                minWidth: 48, alignItems: "center" },
  addBtnText: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  teacherAvatarText:{ fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  teacherName:    { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
