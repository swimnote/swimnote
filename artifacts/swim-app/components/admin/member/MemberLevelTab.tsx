    ...
    <ScrollView contentContainerStyle={ms.tabContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[ms.infoCard, { backgroundColor: C.card }]}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 16, padding: 16 }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 22, fontFamily: "Pretendard-Regular", color: C.text, marginTop: 2 }}>
              ...
              {levelInfo?.current_level?.is_active === false && (
                <View style={{ flexDirection: "row", alignItems: "center", gap: 5, marginTop: 4, backgroundColor: "#FFF7ED", borderRadius: 6, paddingHorizontal: 8, paddingVertical: 4, alignSelf: "flex-start" }}>
                  <LucideIcon name="eye-off" size={12} color="#D97706" />
                  <Text style={{ fontSize: 12, fontFamily: "Pretendard-Regular", color: "#D97706" }}>사용 안 함 레벨</Text>
                </View>
              )}
            ...
            >
              ...
              <Text style={{ fontSize: 13, fontFamily: "Pretendard-Regular", color: themeColor }}>변경</Text>
            </Pressable>
          </View>
          ...
          {levelInfo?.current_level?.learning_content ? (
            <View style={{ paddingHorizontal: 16, paddingBottom: 14 }}>
              ...
              <Text style={{ fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textSecondary, marginBottom: 6 }}>이 레벨에서 배우는 내용</Text>
          ...
          {levelInfo?.current_level?.promotion_test_rule ? (
            <View style={{ paddingHorizontal: 16, paddingBottom: 14 }}>
              ...
              <Text style={{ fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textSecondary, marginBottom: 6 }}>승급 기준</Text>
              <Text style={{ fontSize: 14, fontFamily: "Pretendard-Regular", color: C.text, lineHeight: 22 }}>
                {levelInfo.current_level.promotion_test_rule}
              </Text>
            </View>
              ...
              {levelInfo.all_levels.filter(lv => lv.is_active !== false).map(lv => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={{ fontSize: 11, fontFamily: isCurrent ? "Pretendard-Regular" : "Pretendard-Regular", color: isCurrent ? themeColor : C.textSecondary }}>
                      {lv.level_name}
                    </Text>
                  </Pressable>
                );
        ...
        <View style={[ms.infoCard, { backgroundColor: C.card, padding: 14, gap: 10 }]}>
          ...
          >
            {saving ? <ActivityIndicator color="#fff" size="small" /> : (
              <><LucideIcon name="save" size={16} color="#fff" /><Text style={ms.saveBtnText}>메모 저장</Text></>
            )}
          </Pressable>
        </View>
      </View>
      ...
      <Modal visible={showLevelPicker} transparent animationType="slide" onRequestClose={onCloseLevelPicker}>
        ...
        >
          ...
          >
            <Text style={{ fontSize: 17, fontFamily: "Pretendard-Regular", color: C.text, textAlign: "center" }}>레벨 선택</Text>
                ...
                {(levelInfo?.all_levels ?? []).filter(lv => lv.is_active !== false).map(lv => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <Text style={{ fontSize: 12, fontFamily: isCurrent ? "Pretendard-Regular" : "Pretendard-Regular", color: isCurrent ? themeColor : C.text }}>
                        {lv.level_name}
                      </Text>
                    </Pressable>
                  );
