...
const ts = StyleSheet.create({
  ...
  sheetTitle: { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  ...
  addBtnText: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  teacherName: { fontSize: 15, fontFamily: "Pretendard-Medium" },
  ...
  selfBadgeText: { fontSize: 10, fontFamily: "Pretendard-Medium" },
  ...
  codeText: { fontSize: 28, fontFamily: "Pretendard-SemiBold", letterSpacing: 6 },
