...
const ts = StyleSheet.create({
  ...
  sheetTitle: { fontSize: 18, fontFamily: "Pretendard-Regular" },
  ...
  addBtnText: { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#fff" },
  ...
  switchLabel: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  selfBadgeText: { fontSize: 10, fontFamily: "Pretendard-Regular" },
