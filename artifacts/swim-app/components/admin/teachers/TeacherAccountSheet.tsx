...
const ts = StyleSheet.create({
  ...
  sheetTitle: { fontSize: 18, fontFamily: "Pretendard-Bold" },
  ...
  addBtnText: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  input: { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, height: 48, fontSize: 15, fontFamily: "Pretendard-Regular" },
  switchRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 12, borderTopWidth: 1 },
  switchLabel: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  teacherName: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  selfBadgeText: { fontSize: 10, fontFamily: "Pretendard-SemiBold" },
  codeBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, paddingVertical: 10, borderTopWidth: 1 },
  codeBtnText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  codeBox: { padding: 16, alignItems: "center" },
  codeText: { fontSize: 28, fontFamily: "Pretendard-Bold", letterSpacing: 6 },
