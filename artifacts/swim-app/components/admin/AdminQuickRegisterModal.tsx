...
const qr = StyleSheet.create({
  ...
  title:    { fontSize: 20, fontFamily: "Pretendard-Bold", color: C.text },
  ...
  weekBtnTxt:{ fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  doneTitle:{ fontSize: 20, fontFamily: "Pretendard-Bold", color: C.text },
