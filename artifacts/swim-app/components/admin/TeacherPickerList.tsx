...
const t = StyleSheet.create({
  ...
  contextText: { fontSize: 13, fontFamily: "Inter_600SemiBold" },
  timePill: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  timePillText: { fontSize: 12, fontFamily: "Inter_700Bold", color: "#fff" },
  ...
  position: { fontSize: 12, fontFamily: "Inter_500Medium", marginBottom: 2 },
