...
const t = StyleSheet.create({
  ...
  contextText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  timePill: { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  timePillText: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  name: { fontSize: 16, fontFamily: "Pretendard-Medium", marginBottom: 2 },
