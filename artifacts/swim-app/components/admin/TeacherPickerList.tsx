...
const t = StyleSheet.create({
  ...
  name: { fontSize: 16, fontFamily: "Pretendard-Regular", marginBottom: 2 },
  position: { fontSize: 12, fontFamily: "Pretendard-Regular", marginBottom: 2 },
  ...
  badgeText: { fontSize: 10, fontFamily: "Pretendard-Regular" },
