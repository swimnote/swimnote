...
const inv = StyleSheet.create({
  ...
  codeLabel:{ fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textSecondary },
  code:     { fontSize: 18, fontFamily: "Pretendard-Regular", color: C.tint, letterSpacing: 3 },
  ...
  smsBtnTxt: { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#fff" },
