...
const pd = StyleSheet.create({
  ...
  name:       { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  matchTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  sTitle:     { fontSize: 11, fontFamily: "Pretendard-Medium", color: C.textSecondary, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 2 },
  infoRow:    { flexDirection: "row", justifyContent: "space-between", gap: 12 },
  infoLabel:  { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.textSecondary },
  infoValue:  { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.text, textAlign: "right", flex: 1 },
  ...
  childNumTxt:{ fontSize: 11, fontFamily: "Pretendard-SemiBold" },
  ...
  btnTxt:        { fontSize: 14, fontFamily: "Pretendard-Medium" },
