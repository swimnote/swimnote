            ...
            {loading ? (
              ...
              <View style={[hm.calCard, { backgroundColor: C.card }]}>
                    ...
                    {calCells.slice(wi * 7, wi * 7 + 7).map((dateStr, di) => {
                      ...
                      return (
                        <Pressable key={dateStr} style={[hm.calCell, { width: CELL }]} onPress={() => toggleDay(dateStr)}>
                          <View style={[hm.dayCircle, isHoli && { backgroundColor: isSun || isPubH ? "#D96C6C" : "#14283D" }]}>
                ...
                <View style={hm.legend}>
                  ...
                  <View style={hm.legendItem}><View style={[hm.legendDot, { backgroundColor: "#0F2742" }]} /><Text style={[hm.legendTxt, { color: C.textMuted }]}>지정 휴무일</Text></View>
                </View>
              </View>
            )}
...
const hm = StyleSheet.create({
  ...
  optTitle: { fontSize: 12, fontFamily: "Pretendard-Regular" },
  ...
  optBtnLabel: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  ...
  weekdayBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  calCard: { borderRadius: 16, padding: 14, gap: 8 },
  calWeekRow: { flexDirection: "row" },
  calHeaderCell: { height: 28, alignItems: "center", justifyContent: "center" },
  calHeaderTxt: { fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textSecondary },
  calCell: { height: 56, alignItems: "center", paddingTop: 4, gap: 2 },
  dayCircle: { width: 32, height: 32, borderRadius: 16, alignItems: "center", justifyContent: "center" },
  dayNum: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  holiLabel: { fontSize: 9, fontFamily: "Pretendard-Regular", color: "#D96C6C" },
  ...
  savedMsg: { textAlign: "center", fontSize: 14, fontFamily: "Pretendard-Regular" },
  saveBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 15, borderRadius: 14 },
  saveBtnTxt: { fontSize: 15, fontFamily: "Pretendard-Regular", color: "#fff" },
});
