...
const hm = StyleSheet.create({
  ...
  optTitle: { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  ...
  optBtnLabel: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  savedMsg: { textAlign: "center", fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  saveBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 15, borderRadius: 14 },
  saveBtnTxt: { fontSize: 15, fontFamily: "Pretendard-Bold", color: "#fff" },
});
