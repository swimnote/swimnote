...
const dm = StyleSheet.create({
  ...
  headerAvatarText: { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  headerName: { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  sectionTitle: { fontSize: 12, fontFamily: "Pretendard-Medium", color: C.textSecondary, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 2 },
  ...
  actionBtnText: { fontSize: 15, fontFamily: "Pretendard-Medium" },
  ...
  smBtnText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
});
