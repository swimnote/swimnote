...
const ab = StyleSheet.create({
  ...
  title:        { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  choiceBtnText:{ fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  choiceSub:    { fontSize: 11, fontFamily: "Pretendard-Regular", color: C.textSecondary, textAlign: "center" },
  btn:          { height: 50, borderRadius: 14, alignItems: "center", justifyContent: "center" },
  btnText:      { color: "#fff", fontSize: 15, fontFamily: "Pretendard-Medium" },
  sectionLabel: { fontSize: 13, fontFamily: "Pretendard-Medium", marginTop: 8, marginBottom: 4 },
  studentRow:   { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, borderRadius: 12, borderWidth: 1.5, marginBottom: 6 },
  studentName:  { flex: 1, fontSize: 14, fontFamily: "Pretendard-Medium" },
  studentTag:   { fontSize: 12, fontFamily: "Pretendard-Medium" },
  resultBox:    { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 16, borderRadius: 14 },
  resultText:   { flex: 1, fontSize: 14, fontFamily: "Pretendard-Medium", lineHeight: 22 },
});
