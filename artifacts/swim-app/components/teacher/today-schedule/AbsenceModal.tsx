...
const ab = StyleSheet.create({
  ...
  choiceBtnText:{ fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  btnText:      { color: "#fff", fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  sectionLabel: { fontSize: 13, fontFamily: "Pretendard-SemiBold", marginTop: 8, marginBottom: 4 },
  ...
  studentTag:   { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
