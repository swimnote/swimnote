...
const ab = StyleSheet.create({
  ...
  choiceBtnText:{ fontSize: 16, fontFamily: "Pretendard-Regular" },
  ...
  btnText:      { color: "#fff", fontSize: 15, fontFamily: "Pretendard-Regular" },
  sectionLabel: { fontSize: 13, fontFamily: "Pretendard-Regular", marginTop: 8, marginBottom: 4 },
  studentRow:   { flexDirection: "row", alignItems: "center", gap: 10, padding: 12, borderRadius: 12, borderWidth: 1.5, marginBottom: 6 },
  studentName:  { flex: 1, fontSize: 14, fontFamily: "Pretendard-Regular" },
  studentTag:   { fontSize: 12, fontFamily: "Pretendard-Regular" },
  resultBox:    { flexDirection: "row", alignItems: "flex-start", gap: 10, padding: 16, borderRadius: 14 },
  resultText:   { flex: 1, fontSize: 14, fontFamily: "Pretendard-Regular", lineHeight: 22 },
});
