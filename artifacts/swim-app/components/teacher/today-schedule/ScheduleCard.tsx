...
const card = StyleSheet.create({
  ...
  time:          { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  name:          { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  noteBadgeText: { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#D97706" },
  ...
  actionText:    { fontSize: 12, fontFamily: "Pretendard-Medium" },
});
