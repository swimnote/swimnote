...
const ms = StyleSheet.create({
  ...
  sheetTitle: { fontSize: 18, fontFamily: "Pretendard-Bold", color: C.text },
  ...
  recTime:    { fontSize: 14, fontFamily: "Pretendard-Bold", minWidth: 36 },
  recBtn:     { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 10 },
  recBtnText: { color: "#fff", fontSize: 12, fontFamily: "Pretendard-SemiBold" },
