...
const um = StyleSheet.create({
  ...
  title:      { fontSize: 17, fontFamily: "Pretendard-SemiBold", flex: 1 },
  countBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  countTxt:   { color: "#fff", fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  itemName:   { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
