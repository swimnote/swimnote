...
const dm = StyleSheet.create({
  ...
  headerTitle:   { fontSize: 16, fontFamily: "Pretendard-SemiBold", flex: 1, textAlign: "center" },
  section:       { gap: 10 },
  sectionHeader: { flexDirection: "row", alignItems: "center", gap: 8 },
  sectionTitle:  { fontSize: 15, fontFamily: "Pretendard-Medium" },
  ...
  recTime:       { fontSize: 16, fontFamily: "Pretendard-SemiBold", minWidth: 44 },
  ...
  stopBtnText:   { color: "#fff", fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  startRecText:  { fontSize: 15, fontFamily: "Pretendard-Medium" },
