                ...
                <View style={{ gap: 12 }}>
                  <View style={dm.playerRow}>
                    <Pressable style={[dm.playerBtn, { backgroundColor: "#4EA7D8" }]} onPress={playAudio}>
                      <LucideIcon name={playing ? "pause" : "play"} size={18} color="#fff" />
                    </Pressable>
...
const dm = StyleSheet.create({
  ...
  headerTitle:   { fontSize: 16, fontFamily: "Pretendard-Regular", flex: 1, textAlign: "center" },
  section:       { gap: 10 },
  ...
  recTime:       { fontSize: 16, fontFamily: "Pretendard-Regular", minWidth: 44 },
  ...
  stopBtnText:   { color: "#fff", fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  playerStatus:  { fontSize: 11, fontFamily: "Pretendard-Regular" },
  ...
  rerecordText:  { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  startRecText:  { fontSize: 15, fontFamily: "Pretendard-Regular" },
