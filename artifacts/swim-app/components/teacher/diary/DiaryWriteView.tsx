            ...
            <View style={[s.noteInput, { backgroundColor: "#EEDDF5", borderColor: "#8B5CF6" }]}>
              ...
              <View style={{ flexDirection: "row", gap: 8, marginTop: 8 }}>
                <Pressable style={[s.noteBtn, { borderColor: C.border }]} onPress={() => { setAddNoteStudent(null); setNoteInput(""); }}>
                  <Text style={{ color: C.textSecondary, fontFamily: "Pretendard-Medium", fontSize: 13 }}>취소</Text>
                </Pressable>
                <Pressable style={[s.noteBtn, { backgroundColor: "#8B5CF6", borderColor: "#8B5CF6", flex: 1 }]} onPress={onAddNote} disabled={!noteInput.trim()}>
                  <Text style={{ color: "#fff", fontFamily: "Pretendard-Medium", fontSize: 13 }}>추가</Text>
                </Pressable>
              </View>
            </View>
          )}
...
export const s = StyleSheet.create({
  ...
  cardTitle:     { fontSize: 14, fontFamily: "Pretendard-SemiBold", flex: 1 },
  ...
  templateBtnText: { fontSize: 12, fontFamily: "Pretendard-Medium" },
  templateList:  { gap: 6 },
  templateItem:  { borderRadius: 10, padding: 12, gap: 4 },
  templateText:  { fontSize: 13, fontFamily: "Pretendard-Regular", lineHeight: 20 },
  templateCategory: { fontSize: 11, fontFamily: "Pretendard-Medium" },
  ...
  sentencePickBtnText: { fontSize: 12, fontFamily: "Pretendard-Medium", color: Colors.light.tint },
  ...
  sectionLabel:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  noteName:      { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#7C3AED" },
  ...
  mediaBtnText:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  cancelBtnFtText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  infoCardText:  { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  tabBtnText:    { fontSize: 12, fontFamily: "Pretendard-Medium" },
