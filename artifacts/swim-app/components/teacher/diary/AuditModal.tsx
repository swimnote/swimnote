...
const a = StyleSheet.create({
  ...
  sheetTitle:      { fontSize: 16, fontFamily: "Pretendard-Regular" },
  ...
  logBadgeText:    { fontSize: 11, fontFamily: "Pretendard-Regular" },
  logTarget:       { fontSize: 12, fontFamily: "Pretendard-Regular", color: "#64748B" },
  ...
  logContentLabel: { fontSize: 11, fontFamily: "Pretendard-Regular", color: "#64748B" },
