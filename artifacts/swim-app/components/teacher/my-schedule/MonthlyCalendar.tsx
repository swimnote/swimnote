...
const mc = StyleSheet.create({
  ...
  dayNum:         { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  timePillText:   { fontSize: 10, fontFamily: "Pretendard-Regular" },
  ...
  moreTxt:        { fontSize: 9, fontFamily: "Pretendard-Regular", color: C.textMuted },
  holidayTag:     { fontSize: 10, fontFamily: "Pretendard-Regular", color: "#D96C6C", marginTop: 2 },
});
