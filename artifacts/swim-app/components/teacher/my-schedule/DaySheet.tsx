...
const dy = StyleSheet.create({
  ...
  dateTitle:        { fontSize: 17, fontFamily: "Inter_700Bold", color: C.text },
  dateSub:          { fontSize: 12, fontFamily: "Inter_400Regular", color: C.textMuted, marginTop: 2 },
  ...
  className:        { fontSize: 14, fontFamily: "Inter_600SemiBold", color: C.text, marginTop: 2 },
  ...
  memoLabel:        { fontSize: 13, fontFamily: "Inter_600SemiBold", color: C.textSecondary, flex: 1 },
  ...
  memoContent:      { fontSize: 13, fontFamily: "Inter_400Regular", color: C.text, lineHeight: 20 },
  memoEmpty:        { fontSize: 12, fontFamily: "Inter_400Regular", color: C.textMuted },
  audioDivider:     { height: 1, backgroundColor: "#F3E8C0", marginVertical: 10 },
  audioRow:         { flexDirection: "row", alignItems: "center", gap: 6 },
  audioLabel:       { fontSize: 13, fontFamily: "Inter_600SemiBold", color: C.textSecondary },
  ...
  recordingTxt:     { fontSize: 11, fontFamily: "Inter_400Regular", color: "#D96C6C" },
