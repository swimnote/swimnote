...
const dy = StyleSheet.create({
  ...
  dateTitle:        { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  headerBtnTxt:     { fontSize: 12, fontFamily: "Pretendard-Medium" },
  closeBtn:         { padding: 6 },
  ...
  emptyActionTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  className:        { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text, marginTop: 2 },
  ...
  attBadgeTxt:      { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
  ...
  diaryBadgeTxt:    { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#7C3AED" },
  ...
  memoLabel:        { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.textSecondary, flex: 1 },
  memoEditBtn:      { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8, backgroundColor: "#fff" },
  memoEditBtnTxt:   { fontSize: 12, fontFamily: "Pretendard-Medium" },
  memoEditArea:     {},
  ...
  memoCancelBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  memoSaveBtn:      { flex: 1, paddingVertical: 8, borderRadius: 8, alignItems: "center" },
  memoSaveBtnTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  audioLabel:       { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  audioBtn:         { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8 },
  audioBtnTxt:      { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  audioListLabel:   { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#92400E" },
