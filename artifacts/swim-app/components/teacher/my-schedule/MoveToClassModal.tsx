...
const rm = StyleSheet.create({
  ...
  name:        { fontSize: 15, fontFamily: "Pretendard-Medium", color: C.text },
  weeklyBadge: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: C.tint, marginTop: 2 },
  ...
  moveTxt:     { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  pickName:    { fontSize: 15, fontFamily: "Pretendard-Medium", color: C.text },
