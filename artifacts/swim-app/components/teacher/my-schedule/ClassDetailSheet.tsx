            ...
            <ScrollView style={cds.studentScroll} showsVerticalScrollIndicator={false}>
              ...
              {myLogs.length > 0 && (
                <View style={{ paddingHorizontal: 16, paddingTop: 8, paddingBottom: 4 }}>
                  <Text style={{ fontSize: 12, fontFamily: "Pretendard-Medium", color: "#D97706", marginBottom: 4 }}>
                    변경 이력
                  </Text>
                  {myLogs.map(log => {
...
const cds = StyleSheet.create({
  ...
  actionText:      { fontSize: 13, fontFamily: "Pretendard-Medium" },
  sectionLabel:    { fontSize: 12, fontFamily: "Pretendard-Medium", color: C.textMuted,
  ...
  moveClassName:   { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
  ...
  moveConfirmTxt:  { fontSize: 15, fontFamily: "Pretendard-Medium", color: "#fff" },
  unassignBtn:     { flexDirection: "row", alignItems: "center", gap: 8,
                     marginHorizontal: 12, marginBottom: 8,
                     paddingHorizontal: 14, paddingVertical: 12,
                     backgroundColor: "#FFF8EE", borderRadius: 10,
                     borderWidth: 1, borderColor: "#FCD34D" },
  unassignBtnTxt:  { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#D97706" },
  timingRow:       { flexDirection: "row", alignItems: "center", gap: 10,
                     paddingHorizontal: 16, paddingVertical: 14,
                     borderTopWidth: 1, borderTopColor: "#F8FAFC" },
  timingLabel:     { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
