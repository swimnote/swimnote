      ...
      >
              ...
              <View style={[styles.guideCard, { backgroundColor: "#F5F3FF", borderColor: "#E6FAF8" }]}>
                ...
                <View style={styles.guideRow}>
                  ...
                  <Text style={[styles.guideText, { color: "#5B21B6" }]}>
                    App Store / Play Store에서 <Text style={{ fontFamily: "Pretendard-Regular" }}>"Google Authenticator"</Text> 검색 후 설치
                  </Text>
                </View>
                <View style={styles.guideRow}>
        ...
        {step === "qr" && (
          <View style={[styles.card, { backgroundColor: C.card }]}>
            ...
            <Text style={[styles.cardDesc, { color: C.textSecondary }]}>
              Google Authenticator 앱 열기 → <Text style={{ fontFamily: "Pretendard-Regular" }}>+</Text> 버튼 → <Text style={{ fontFamily: "Pretendard-Regular" }}>QR 코드 스캔</Text>
            </Text>
...
const styles = StyleSheet.create({
  ...
  statusText: { fontSize: 13, fontFamily: "Pretendard-Regular", flex: 1, lineHeight: 18 },
  alertBox: {
    flexDirection: "row", alignItems: "flex-start", gap: 8,
    padding: 12, borderRadius: 12, borderWidth: 1,
  },
  alertText: { fontSize: 13, fontFamily: "Pretendard-Regular", flex: 1, lineHeight: 18 },
  card: {
  ...
  cardTitle: { fontSize: 18, fontFamily: "Pretendard-Regular", textAlign: "center" },
  ...
  otpBoxText: { fontSize: 24, fontFamily: "Pretendard-Regular" },
  ...
  guideTitle: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  guideRow: { flexDirection: "row", gap: 10, alignItems: "flex-start" },
  guideNum: {
    width: 20, height: 20, borderRadius: 10,
    alignItems: "center", justifyContent: "center", marginTop: 1, flexShrink: 0,
  },
  guideNumTxt: { fontSize: 11, fontFamily: "Pretendard-Regular", color: "#fff" },
