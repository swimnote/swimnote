...
const styles = StyleSheet.create({
  ...
  stepText: { fontSize: 13, fontFamily: "Pretendard-Bold", color: "#fff" },
  ...
  previewLabel: { fontSize: 11, fontFamily: "Pretendard-SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  previewNickname: { fontSize: 24, fontFamily: "Pretendard-Bold" },
  field: { gap: 8 },
  ...
  suffixText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  skipBtnText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
