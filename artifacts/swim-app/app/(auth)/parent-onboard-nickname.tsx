...
const styles = StyleSheet.create({
  ...
  stepText: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  previewLabel: { fontSize: 11, fontFamily: "Pretendard-Medium", textTransform: "uppercase", letterSpacing: 0.5 },
  previewNickname: { fontSize: 24, fontFamily: "Pretendard-SemiBold" },
  field: { gap: 8 },
