    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={styles.btnRow}>
          ...
          <Pressable
            style={({ pressed }) => [styles.confirmBtn, { backgroundColor: C.primaryAction, opacity: pressed || loading ? 0.85 : 1, flex: 1 }]}
...
const styles = StyleSheet.create({
  ...
  stepText: { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#fff" },
  ...
  suffixText: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  ...
  skipBtnText: { fontSize: 14, fontFamily: "Pretendard-Regular" },
