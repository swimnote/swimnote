      ...
      <View style={[styles.root, { backgroundColor: C.background }]}>
        <View style={[styles.doneWrap, { paddingTop: insets.top + 60 }]}>
          ...
          <Text style={[styles.doneDesc, { color: C.textSecondary }]}>
            <Text style={{ fontFamily: "Pretendard-SemiBold", color: C.text }}>{invite?.pool_name}</Text>
            {" "}에 가입되었습니다.{"\n"}
            아이디{" "}
            <Text style={{ fontFamily: "Pretendard-Bold", color: C.text }}>{loginId}</Text>
            {"\n"}로 로그인해주세요.
          </Text>
          <Pressable
...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontSize: 20, fontFamily: "Pretendard-Bold", textAlign: "center" },
  ...
  codeInput: { flex: 1, fontSize: 18, fontFamily: "Pretendard-Bold", letterSpacing: 3, textAlign: "center" },
  ...
  infoValue: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
