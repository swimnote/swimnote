...
const styles = StyleSheet.create({
  ...
  orgName: { fontSize: 15, fontFamily: "Pretendard-Medium" },
  ...
  signupBtnText: { color: "#fff", fontSize: 15, fontFamily: "Pretendard-Medium" },
  ...
  roleTitle: { fontSize: 20, fontFamily: "Pretendard-SemiBold", textAlign: "center" },
});
