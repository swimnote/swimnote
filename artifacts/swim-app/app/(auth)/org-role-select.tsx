...
const styles = StyleSheet.create({
  ...
  orgName: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  emptyTitle: { fontSize: 17, fontFamily: "Pretendard-Bold" },
  ...
  signupBtnText: { color: "#fff", fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  roleTitle: { fontSize: 20, fontFamily: "Pretendard-Bold", textAlign: "center" },
});
