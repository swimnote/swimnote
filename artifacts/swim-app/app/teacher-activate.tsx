...
const styles = StyleSheet.create({
  ...
  otpInput: { width: 48, height: 56, borderRadius: 14, borderWidth: 2, fontSize: 24, fontFamily: "Pretendard-Bold" },
  btn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", height: 52, borderRadius: 16, marginTop: 8 },
  btnText: { color: "#fff", fontSize: 17, fontFamily: "Pretendard-SemiBold" },
  ...
  successTitle: { fontSize: 24, fontFamily: "Pretendard-Bold" },
