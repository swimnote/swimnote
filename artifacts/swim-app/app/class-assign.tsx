...
const rt = StyleSheet.create({
  ...
  title:     { fontSize: 17, fontFamily: "Pretendard-Bold", color: C_rt.text, textAlign: "center" },
  ...
  optLabel:  { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: C_rt.error },
...
const s = StyleSheet.create({
  ...
  className: { fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  countText: { fontSize: 13, fontFamily: "Pretendard-Bold" },
  sectionHeader: {
  ...
  doneTxt: { fontSize: 16, fontFamily: "Pretendard-Bold" },
});
...
const r = StyleSheet.create({
  ...
  name: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
...
const wp = StyleSheet.create({
  ...
  title: { fontSize: 18, fontFamily: "Pretendard-Bold", color: C.text, textAlign: "center" },
  ...
  optNum: { fontSize: 16, fontFamily: "Pretendard-Bold", color: C.tint },
