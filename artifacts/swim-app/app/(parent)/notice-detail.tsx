...
const styles = StyleSheet.create({
  ...
  pinnedText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  individualText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  title: { fontSize: 20, fontFamily: "Pretendard-SemiBold", lineHeight: 28 },
