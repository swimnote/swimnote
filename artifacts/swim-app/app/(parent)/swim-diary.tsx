...
const s = StyleSheet.create({
  ...
  cardTeacher: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  editedBadgeText: { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#92400E" },
  ...
  sectionLabel: { fontSize: 11, fontFamily: "Pretendard-SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
