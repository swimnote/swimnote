...
const styles = StyleSheet.create({
  ...
  monthText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  statsRow: { flexDirection: "row", gap: 10, paddingHorizontal: 20, marginBottom: 16 },
  statBox: { flex: 1, borderRadius: 14, paddingVertical: 14, alignItems: "center", gap: 4 },
  statNum: { fontSize: 24, fontFamily: "Pretendard-Bold" },
  ...
  badgeText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
