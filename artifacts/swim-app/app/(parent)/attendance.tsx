...
const styles = StyleSheet.create({
  ...
  rateNum: { fontSize: 32, fontFamily: "Pretendard-SemiBold" },
  rateLabel: { fontSize: 11, fontFamily: "Pretendard-Regular", marginTop: 2 },
  divider: { width: 1, height: 40 },
  statItem: { alignItems: "center", flex: 1 },
  statNum: { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
  ...
  monthText: { fontSize: 12, fontFamily: "Pretendard-Medium", textTransform: "uppercase", letterSpacing: 0.5 },
