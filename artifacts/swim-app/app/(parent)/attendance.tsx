...
const styles = StyleSheet.create({
  ...
  rateNum: { fontSize: 32, fontFamily: "Pretendard-Bold" },
  rateLabel: { fontSize: 11, fontFamily: "Pretendard-Regular", marginTop: 2 },
  divider: { width: 1, height: 40 },
  statItem: { alignItems: "center", flex: 1 },
  statNum: { fontSize: 20, fontFamily: "Pretendard-Bold" },
  ...
  monthText: { fontSize: 12, fontFamily: "Pretendard-SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  recordInfo: { flex: 1 },
  recordDate: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  recordMember: { fontSize: 12, fontFamily: "Pretendard-Regular", marginTop: 2 },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10 },
  statusText: { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
