...
const ds = StyleSheet.create({
  ...
  dateMonth: { fontSize: 11, fontFamily: "Pretendard-Medium", color: "rgba(255,255,255,0.8)" },
  dateDay: { fontSize: 22, fontFamily: "Pretendard-SemiBold", color: "#fff", lineHeight: 26 },
  dateWeekday: { fontSize: 11, fontFamily: "Pretendard-Medium", color: "rgba(255,255,255,0.8)" },
  cardMeta: { flex: 1, gap: 4 },
  metaRow: { flexDirection: "row", alignItems: "center", gap: 6, flexWrap: "wrap" },
  teacher: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  sectionLabel: { fontSize: 11, fontFamily: "Pretendard-SemiBold", textTransform: "uppercase" },
  ...
  noteTitle: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#7C3AED", flex: 1 },
  ...
  reactionLabel: { fontSize: 12, fontFamily: "Pretendard-Medium" },
...
const ts = StyleSheet.create({
  ...
  toastTxt: { color: "#fff", fontSize: 13, fontFamily: "Pretendard-Medium" },
});
