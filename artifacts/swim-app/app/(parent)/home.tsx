        ...
        >
          ...
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center", gap: 24, paddingVertical: 40 }}>
            ...
            <View style={{ alignItems: "center", gap: 10 }}>
              <Text style={{ fontSize: 20, fontFamily: "Pretendard-SemiBold", color: C.text }}>연결된 자녀가 없습니다</Text>
            ...
            >
              <Text style={{ color: "#fff", fontSize: 16, fontFamily: "Pretendard-Medium" }}>자녀 연결하기</Text>
            </Pressable>
...
const s = StyleSheet.create({
  ...
  childTabTxt: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  infoAvatarTxt: { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  infoName: { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  badgeTxt: { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  newsTagTxt: { fontSize: 11, fontFamily: "Pretendard-Medium" },
  unreadDot: { width: 7, height: 7, borderRadius: 4 },
  newsDate: { fontSize: 12, fontFamily: "Pretendard-Regular" },
  newsTitle: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
