...
const styles = StyleSheet.create({
  ...
  appSub: { fontSize: 18, fontFamily: "Pretendard-Medium", textAlign: "center" },
  ...
  signupBtnText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  modalTitle: { fontSize: 17, fontFamily: "Pretendard-SemiBold", textAlign: "center" },
  ...
  modalBtnText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
});
