...
const styles = StyleSheet.create({
  ...
  appSub: { fontSize: 18, fontFamily: "Pretendard-SemiBold", textAlign: "center" },
  ...
  forgotText: { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  signupBtnText: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  modalTitle: { fontSize: 17, fontFamily: "Pretendard-Bold", textAlign: "center" },
  ...
  modalBtnText: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
});
