...
const styles = StyleSheet.create({
  ...
  errorTxt: { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular" },
  poolCard: {
  ...
  poolName: { fontSize: 17, fontFamily: "Inter_700Bold", flexShrink: 1 },
  currentBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  currentBadgeTxt: { color: "#fff", fontSize: 11, fontFamily: "Inter_600SemiBold" },
  ...
  logoutTxt: { fontSize: 14, fontFamily: "Inter_400Regular" },
});
