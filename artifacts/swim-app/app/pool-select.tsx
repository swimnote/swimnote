...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontFamily: "Pretendard-Bold", textAlign: "center" },
  ...
  poolName: { fontSize: 17, fontFamily: "Pretendard-Bold", flexShrink: 1 },
  currentBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  currentBadgeTxt: { color: "#fff", fontSize: 11, fontFamily: "Pretendard-SemiBold" },
