...
const styles = StyleSheet.create({
  ...
  timerTxt:     { fontSize: 13, fontFamily: "Pretendard-SemiBold", marginRight: 4 },
  ...
  devCodeNum:     { fontSize: 16, fontFamily: "Pretendard-Bold", color: "#856404", letterSpacing: 2 },
  sectionDivider: { flexDirection: "row", alignItems: "center", gap: 8, marginVertical: 4 },
  sectionLine:    { flex: 1, height: 1 },
  sectionLabel:   { fontSize: 12, fontFamily: "Pretendard-SemiBold", paddingHorizontal: 4 },
  ...
  footerLink:   { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
});
