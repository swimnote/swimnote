...
function Field({ label, icon, children }: { label: string; icon: any; children: React.ReactNode }) {
  ...
  return (
    <View style={styles.fieldWrap}>
      ...
      <View style={[styles.inputBox, { borderColor: C.border, backgroundColor: C.background }]}>
        <LucideIcon name={icon} size={16} color={C.textMuted} style={styles.inputIcon} />
        {children}
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, fontFamily: "Pretendard-Regular", textAlign: "center", lineHeight: 22 },
  ...
  sectionTitle: { fontSize: 15, fontFamily: "Pretendard-SemiBold", marginTop: 12 },
  fieldWrap: { gap: 4 },
  ...
  noticeText: { fontSize: 12, fontFamily: "Pretendard-Regular", flex: 1, lineHeight: 18 },
