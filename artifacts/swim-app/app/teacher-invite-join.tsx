...
const styles = StyleSheet.create({
  ...
  primaryBtnText: { color: "#fff", fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  invitePoolName: { fontSize: 16, fontFamily: "Pretendard-Bold" },
