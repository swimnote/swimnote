...
const styles = StyleSheet.create({
  ...
  sectionSub: { fontSize: 14, fontFamily: "Inter_400Regular", lineHeight: 22 },
  ...
  invitePoolName: { fontSize: 16, fontFamily: "Inter_700Bold" },
  invitePosition: { fontSize: 13, fontFamily: "Inter_400Regular", marginTop: 2 },
  ...
  donePoolName: { fontSize: 14, fontFamily: "Inter_600SemiBold" },
