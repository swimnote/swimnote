...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
  ...
  primaryBtnText: { color: "#fff", fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  ...
  invitePoolName: { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
