...
const rv = StyleSheet.create({
  ...
  summaryAmount:    { fontSize: 32, fontFamily: "Pretendard-Bold", color: "#fff" },
  statsRow:         { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  statItem:         { flex: 1, alignItems: "center", gap: 2 },
  statNum:          { fontSize: 20, fontFamily: "Pretendard-Bold", color: "#fff" },
  ...
  studentName:      { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  studentSub:       { fontSize: 12, fontFamily: "Pretendard-Regular" },
  tag:              { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  tagText:          { fontSize: 10, fontFamily: "Pretendard-SemiBold" },
  settlementAmount: { fontSize: 15, fontFamily: "Pretendard-Bold" },
  ...
  totalLabel:       { fontSize: 14, fontFamily: "Pretendard-Bold" },
  totalAmount:      { fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  inputPrefix:      { fontSize: 16, fontFamily: "Pretendard-SemiBold", marginRight: 8 },
  ...
  extraSummaryText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  msg:              { flexDirection: "row", alignItems: "center", gap: 8, padding: 12, borderRadius: 12 },
  msgText:          { fontSize: 13, fontFamily: "Pretendard-Medium", flex: 1 },
  statusRow:        { flexDirection: "row", alignItems: "center", gap: 10 },
  statusBadge:      { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  statusTxt:        { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  summaryGridVal:   { fontSize: 18, fontFamily: "Pretendard-Bold" },
  ...
  confirmTitle:     { fontSize: 20, fontFamily: "Pretendard-Bold", textAlign: "center" },
  ...
  confirmBtnText:   { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#fff" },
});
