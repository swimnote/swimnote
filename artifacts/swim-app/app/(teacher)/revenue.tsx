...
const rv = StyleSheet.create({
  ...
  monthText:        { fontSize: 17, fontFamily: "Pretendard-SemiBold" },
  ...
  summaryAmount:    { fontSize: 32, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  statsRow:         { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  statItem:         { flex: 1, alignItems: "center", gap: 2 },
  statNum:          { fontSize: 20, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  studentName:      { fontSize: 15, fontFamily: "Pretendard-Medium" },
  studentSub:       { fontSize: 12, fontFamily: "Pretendard-Regular" },
  tag:              { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6 },
  tagText:          { fontSize: 10, fontFamily: "Pretendard-Medium" },
  settlementAmount: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  totalLabel:       { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  totalAmount:      { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  ...
  inputPrefix:      { fontSize: 16, fontFamily: "Pretendard-Medium", marginRight: 8 },
  ...
  extraSummaryText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  statusTxt:        { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  summaryGridVal:   { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  ...
  confirmTitle:     { fontSize: 20, fontFamily: "Pretendard-SemiBold", textAlign: "center" },
