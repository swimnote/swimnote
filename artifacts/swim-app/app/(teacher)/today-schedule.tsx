...
const h = StyleSheet.create({
  ...
  /* 오늘 날짜 배너 */
  todayBanner:    { borderRadius: 20, padding: 16, gap: 4 },
  todayDate:      { fontSize: 12, fontFamily: "Inter_500Medium", color: "rgba(255,255,255,0.85)" },
  todayStatRow:   { flexDirection: "row", alignItems: "center", marginTop: 6 },
  todayStat:      { flex: 1, alignItems: "center", gap: 2, paddingVertical: 3 },
  todayStatNum:   { fontSize: 20, fontFamily: "Inter_700Bold", color: "#fff" },
  todayStatLabel: { fontSize: 10, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.82)" },
  todayDivider:   { width: 1, height: 28, backgroundColor: "rgba(255,255,255,0.25)" },
  /* 섹션 공통 */
  sectionCard:    { borderRadius: 16, padding: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
