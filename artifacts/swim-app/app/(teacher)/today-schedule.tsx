...
const h = StyleSheet.create({
  ...
  poolName:       { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  ...
  todayStatNum:   { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  sectionTitle:   { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: C.text },
  sectionMore:    { fontSize: 12, fontFamily: "Pretendard-Medium" },
  classCnt:       { marginLeft: "auto", fontSize: 11, fontFamily: "Pretendard-Medium" },
  ...
  chipTime:       { fontSize: 11, fontFamily: "Pretendard-SemiBold" },
  ...
  schedHeroTitle:   { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  schedHeroBtnTxt:  { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  ...
  miniDateToday:    { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  gridBadgeTxt:   { color: "#fff", fontSize: 10, fontFamily: "Pretendard-SemiBold" },
  gridLabel:      { fontSize: 11, fontFamily: "Pretendard-Medium", color: C.text, textAlign: "center" },
});
