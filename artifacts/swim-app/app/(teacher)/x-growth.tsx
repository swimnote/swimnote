/**
 * (teacher)/x-growth.tsx — SWIMNOTE X 성장 추적 (교사용) (WP4 placeholder)
 *
 * XModeGuard로 보호: mode !== "x" 이면 today-schedule로 redirect.
 * WP15(교사 UI) 이후 실제 기능으로 교체됩니다.
 */
...
const FEATURES = [
  { icon: "check-circle",  label: "성장 이벤트 승인",    sub: "AI 분석 결과 검토 및 확인" },
  { icon: "bar-chart-2",   label: "학생 성장판",          sub: "수업별 성장 달성률 확인" },
  { icon: "edit-3",        label: "커리큘럼 연동 일지",   sub: "X 전용 일지 작성 및 자동 매칭" },
];
      ...
      <View style={{ flex: 1, backgroundColor: C.background }}>
        ...
        <View style={[s.header, { paddingTop: insets.top + 14 }]}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={s.sub}>AI 기반 커리큘럼 성장 관리</Text>
          </View>
        </View>
