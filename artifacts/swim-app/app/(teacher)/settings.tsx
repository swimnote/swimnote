...
const s = StyleSheet.create({
  ...
  usageLabel:       { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
  usageSub:         { fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textMuted },
  usageBytes:       { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.textSecondary },
  switchSection:    {},
