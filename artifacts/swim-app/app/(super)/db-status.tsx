...
const s = StyleSheet.create({
  ...
  tabTxt:    { fontSize: 12, color: GRAY, fontFamily: "Inter_500Medium" },
  ...
  connLabel: { fontSize: 11, color: GRAY, fontFamily: "Inter_500Medium" },
  ...
  pillLatency:{ fontSize: 10, color: GRAY, fontFamily: "Inter_400Regular" },
  ...
  statNum:   { fontSize: 20, fontFamily: "Inter_700Bold", color: "#1F2937" },
  ...
  dlqError:  { fontSize: 10, color: RED, fontFamily: "Inter_400Regular", marginTop: 3, opacity: 0.8 },
  ...
  resendTxt: { fontSize: 11, color: P, fontFamily: "Inter_600SemiBold" },

  diagBanner:    { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, borderRadius: 12 },
  diagStatusTxt: { fontSize: 14, fontFamily: "Inter_700Bold" },
  diagSubTxt:    { fontSize: 11, color: GRAY, fontFamily: "Inter_400Regular", marginTop: 2 },

  typeRow:  { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 8 },
  typeLabel:{ flex: 1, fontSize: 12, color: "#374151", fontFamily: "Inter_400Regular" },
  typeCnt:  { fontSize: 13, fontFamily: "Inter_700Bold" },

  recCard: { flexDirection: "row", alignItems: "flex-start", gap: 8, backgroundColor: "#FFF8E6", padding: 12, borderRadius: 10 },
  recTxt:  { flex: 1, fontSize: 12, color: ORANGE, fontFamily: "Inter_400Regular" },
