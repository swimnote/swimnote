...
const ps = StyleSheet.create({
  ...
  num:   { fontSize: 15, fontFamily: "Pretendard-Bold" },
...
const s = StyleSheet.create({
  ...
  retryTxt:{ color: "#fff", fontFamily: "Pretendard-SemiBold", fontSize: 14 },
  ...
  tabTxtActive: { color: P, fontFamily: "Pretendard-SemiBold" },
  ...
  badgeTxt:  { color: "#fff", fontSize: 9, fontFamily: "Pretendard-Bold" },

  sectionTitle:    { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 4 },
  sectionTitleTxt: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#374151" },
  ...
  pillTxt:   { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  ...
  resendTxt: { fontSize: 11, color: P, fontFamily: "Pretendard-SemiBold" },

  diagBanner:    { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, borderRadius: 12 },
  diagStatusTxt: { fontSize: 14, fontFamily: "Pretendard-Bold" },
  ...
  typeCnt:  { fontSize: 13, fontFamily: "Pretendard-Bold" },
