...
const ps = StyleSheet.create({
  ...
  num:   { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
...
const s = StyleSheet.create({
  ...
  retryTxt:{ color: "#fff", fontFamily: "Pretendard-Medium", fontSize: 14 },
  ...
  tabTxt:    { fontSize: 12, color: GRAY, fontFamily: "Pretendard-Medium" },
  tabTxtActive: { color: P, fontFamily: "Pretendard-Medium" },
  ...
  badgeTxt:  { color: "#fff", fontSize: 9, fontFamily: "Pretendard-SemiBold" },

  sectionTitle:    { flexDirection: "row", alignItems: "center", gap: 6, marginTop: 4 },
  sectionTitleTxt: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#374151" },

  separationBanner: { flexDirection: "row", alignItems: "center", gap: 8, padding: 12, borderRadius: 10 },
  separationTxt:    { fontSize: 12, fontFamily: "Pretendard-Medium", flex: 1 },
  ...
  connLabel: { fontSize: 11, color: GRAY, fontFamily: "Pretendard-Medium" },
  ...
  pillTxt:   { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  sizeLabel: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  expandTxt: { fontSize: 12, color: P, fontFamily: "Pretendard-Medium" },
  ...
  tableSize: { fontSize: 12, color: GRAY, fontFamily: "Pretendard-Medium" },
  ...
  statNum:   { fontSize: 20, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  poolName:  { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A", marginBottom: 10 },
  ...
  logType: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  resendTxt: { fontSize: 11, color: P, fontFamily: "Pretendard-Medium" },

  diagBanner:    { flexDirection: "row", alignItems: "center", gap: 10, padding: 14, borderRadius: 12 },
  diagStatusTxt: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  typeCnt:  { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
