...
const s = StyleSheet.create({
  ...
  summaryTitle:  { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: "#F1F5F9" },
  ...
  riskNum:       { fontSize: 20, fontFamily: "Pretendard-SemiBold", color: "#64748B" },
  ...
  supportLinkTxt:{ fontSize: 11, fontFamily: "Pretendard-Medium", color: "#fff" },

  serviceCard:   { backgroundColor: "#fff", borderRadius: 14, padding: 14,
                   borderWidth: 1, borderColor: "#E5E7EB", gap: 4 },
  serviceTitle:  { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A", marginBottom: 8 },
  ...
  serviceStatus: { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  allClearTxt:   { fontSize: 15, fontFamily: "Pretendard-Medium", color: "#2E9B6F" },
});
...
const g = StyleSheet.create({
  ...
  countTxt:    { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  viewAll:     { fontSize: 11, fontFamily: "Pretendard-Medium" },

  item:        { flexDirection: "row", alignItems: "center", gap: 8,
                 paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#FFFFFF" },
  itemLeft:    { flex: 1 },
  itemName:    { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  pctTxt:      { fontSize: 11, fontFamily: "Pretendard-SemiBold", minWidth: 30 },
