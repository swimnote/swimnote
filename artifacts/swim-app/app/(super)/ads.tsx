...
const ac = StyleSheet.create({
  ...
  title:      { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
...
const s = StyleSheet.create({
  ...
  sumNum:         { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
...
const m = StyleSheet.create({
  ...
  label:      { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#0F172A", marginBottom: 4, marginTop: 10 },
