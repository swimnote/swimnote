...
function InfoRow({ label, val, valColor = "#14283D" }: { label: string; val: string; valColor?: string }) {
  return (
...
const s = StyleSheet.create({
  ...
  cardName:     { fontSize: 15, fontFamily: "Pretendard-Regular", color: "#14283D" },
...
const m = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#14283D", borderBottomWidth: 1,
  ...
  sessDevice:   { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#14283D" },
  ...
  devRow:       { flexDirection: "row", alignItems: "flex-start", gap: 10, paddingVertical: 6,
                  borderBottomWidth: 1, borderBottomColor: "#FFFFFF" },
  devLabel:     { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#14283D" },
  ...
  hourTxt:      { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#14283D" },
  reasonInput:  { borderWidth: 1.5, borderColor: "#E5E7EB", borderRadius: 10, padding: 12,
                  fontSize: 14, fontFamily: "Pretendard-Regular", color: "#14283D", marginBottom: 4 },
