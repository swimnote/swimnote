...
const s = StyleSheet.create({
  ...
  kpiVal:       { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  ...
  avatarTxt:    { fontSize: 18, fontFamily: "Pretendard-SemiBold" },
  cardNameRow:  { flexDirection: "row", alignItems: "center", gap: 6, flexWrap: "wrap" },
  cardName:     { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  roleTxt:      { fontSize: 10, fontFamily: "Pretendard-SemiBold" },
  lockBadge:    { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6, backgroundColor: "#F9DEDA" },
  lockTxt:      { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: "#D96C6C" },
...
const m = StyleSheet.create({
  ...
  roleTxt:      { fontSize: 11, fontFamily: "Pretendard-SemiBold" },
  section:      { gap: 8, paddingTop: 6 },
  sectionTitle: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#0F172A", borderBottomWidth: 1,
  ...
  infoVal:      { fontSize: 13, fontFamily: "Pretendard-Medium" },
  sessRow:      { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 8,
                  borderBottomWidth: 1, borderBottomColor: "#FFFFFF" },
  sessDevice:   { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  sessKillTxt:  { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#D96C6C" },
  ...
  devRow:       { flexDirection: "row", alignItems: "flex-start", gap: 10, paddingVertical: 6,
                  borderBottomWidth: 1, borderBottomColor: "#FFFFFF" },
  devLabel:     { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  roleRowLabel: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  dangerTxt:    { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#fff" },
});
