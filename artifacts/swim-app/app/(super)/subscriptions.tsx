...
const s = StyleSheet.create({
  ...
  summaryNum:       { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  opName:           { flex: 1, fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  deletionWarn:     { fontSize: 11, fontFamily: "Pretendard-SemiBold", color: "#D96C6C" },
...
const m = StyleSheet.create({
  ...
  linkTxt:   { fontSize: 13, fontFamily: "Pretendard-Medium", color: P },
