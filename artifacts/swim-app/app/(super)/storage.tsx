        ...
        <View style={s.rowMain}>
          ...
          <View style={s.rowMeta}>
            ...
            {isDeletion && <><Text style={s.metaDot}>·</Text>
              <Text style={[s.metaTxt, { color: DANGER, fontFamily: "Pretendard-SemiBold" }]}>{hoursLeft(p.autoDeleteScheduledAt)}</Text></>}
          </View>
          ...
          {stage === 'danger95' || stage === 'blocked100' ? (
            <Pressable style={[s.actionBtn, { backgroundColor: "#ECFEFF" }]}
              ...
              {overrideLoading === p.operatorId
                ...
                : <Text style={[s.actionTxt, { color: "#2EC4B6" }]}>24h허용</Text>}
            </Pressable>
          ) : null}
    ...
    <SafeAreaView style={s.safe} edges={[]}>
      ...
      <View style={s.policyBanner}>
        <Text style={s.policyBannerTxt}>
          <Text style={{ fontFamily: "Pretendard-SemiBold" }}>80%</Text> 경고 → <Text style={{ fontFamily: "Pretendard-SemiBold" }}>95%</Text> 차단 예정(CTA) → <Text style={{ fontFamily: "Pretendard-SemiBold" }}>100%</Text> 업로드 차단
        </Text>
      </View>
...
const s = StyleSheet.create({
  ...
  tabTxtActive:   { color: GREEN, fontFamily: "Pretendard-SemiBold" },
  tabBadge:       { backgroundColor: "#F9DEDA", paddingHorizontal: 5, paddingVertical: 1, borderRadius: 7 },
  tabBadgeTxt:    { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: DANGER },
  ...
  opName:         { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  blockedTag:     { backgroundColor: "#F9DEDA", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5 },
  blockedTagTxt:  { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: DANGER },
  dangerTag:      { backgroundColor: "#FFF1BF", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5 },
  dangerTagTxt:   { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: WARN },
  warnTag:        { backgroundColor: "#FEF9C3", paddingHorizontal: 6, paddingVertical: 2, borderRadius: 5 },
  warnTagTxt:     { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: "#CA8A04" },
  ...
  spikeTxt:       { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: WARN },
  ...
  pctTxt:         { fontSize: 12, fontFamily: "Pretendard-SemiBold", width: 34, textAlign: "right" },
  ...
  ctaCtaTxt:      { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  rowActions:     { gap: 6 },
  actionBtn:      { paddingHorizontal: 8, paddingVertical: 6, borderRadius: 8, minWidth: 44, alignItems: "center" },
  actionTxt:      { fontSize: 11, fontFamily: "Pretendard-Medium" },
...
const m = StyleSheet.create({
  ...
  infoBar:        { backgroundColor: "#FFFFFF", borderRadius: 8, padding: 8 },
  ...
  qtyTxt:         { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  costTxt:        { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#065F46" },
  ...
  cancelBtnFull:  { paddingVertical: 12, borderRadius: 10, backgroundColor: "#FFFFFF", alignItems: "center" },
  ...
  saveTxt:        { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  ctaOptionTitle: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  ctaBtnTxt:      { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
});
