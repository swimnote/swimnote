        ...
        <View style={s.rowMain}>
          ...
          <View style={s.rowMeta}>
            ...
            {isDeletion && <><Text style={s.metaDot}>·</Text>
              <Text style={[s.metaTxt, { color: DANGER, fontFamily: "Pretendard-Regular" }]}>{hoursLeft(p.autoDeleteScheduledAt)}</Text></>}
          </View>
...
const s = StyleSheet.create({
  ...
  spikeTxt:       { fontSize: 9, fontFamily: "Pretendard-Regular", color: WARN },
...
const m = StyleSheet.create({
  ...
  costTxt:        { fontSize: 13, fontFamily: "Pretendard-Regular", color: "#065F46" },
  ...
  ctaBtnTxt:      { fontSize: 12, fontFamily: "Pretendard-Regular", color: "#fff" },
});
