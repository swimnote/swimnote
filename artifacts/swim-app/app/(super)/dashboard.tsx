...
const tr = StyleSheet.create({
  ...
  name:    { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  btnTxt:  { fontSize: 11, fontFamily: "Pretendard-Medium" },
});
...
const ts = StyleSheet.create({
  ...
  title:    { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  badge:    { borderRadius: 10, paddingHorizontal: 7, paddingVertical: 2 },
  badgeTxt: { fontSize: 11, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  body:     { paddingHorizontal: 12, paddingBottom: 8 },
  more:     { alignItems: "center", paddingVertical: 8 },
  moreTxt:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
});
...
const s = StyleSheet.create({
  ...
  headerTitle:   { fontSize: 22, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  alertPillTxt:  { fontSize: 11, fontFamily: "Pretendard-SemiBold", color: "#D96C6C" },
  ...
  statNum:       { fontSize: 24, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  todoHeaderTxt: { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A", flex: 1 },
  todoBadge:     { backgroundColor: "#D96C6C", borderRadius: 10, paddingHorizontal: 7, paddingVertical: 2 },
  todoBadgeTxt:  { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  supportBanner: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#fff",
                   ...
                   marginBottom: 10 },
  supportTitle:  { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  menuTitle:     { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  riskHeaderTxt: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A", flex: 1 },
  ...
  riskNum:       { fontSize: 22, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  auditHeaderTxt:{ fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A", flex: 1 },
  ...
  auditCatTxt:   { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: "#7C3AED" },
