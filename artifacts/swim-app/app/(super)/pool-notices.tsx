...
const r = StyleSheet.create({
  ...
  title:     { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A", flex: 1 },
  meta:      { flexDirection: "row", alignItems: "center", gap: 4 },
  author:    { fontSize: 11, fontFamily: "Pretendard-Medium", color: "#64748B" },
  ...
  pushTxt:   { fontSize: 10, fontFamily: "Pretendard-Medium" },
...
const s = StyleSheet.create({
  ...
  globalBarLabel:{ fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  poolSelectTxt: { flex: 1, fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  addBtn:        { flexDirection: "row", alignItems: "center", gap: 5,
                   paddingHorizontal: 14, paddingVertical: 10, borderRadius: 10 },
  addBtnTxt:     { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#fff" },
...
const pm = StyleSheet.create({
  ...
  title:     { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: "#0F172A", marginBottom: 12 },
  ...
  itemName:  { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
...
const fm = StyleSheet.create({
  ...
  title:        { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: "#0F172A", marginBottom: 8 },
  ...
  scopeTagTxt:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  label:        { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A", marginBottom: 4 },
  ...
  cancelTxt:    { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#64748B" },
...
const dm = StyleSheet.create({
  ...
  delTxt:    { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#fff" },
});
