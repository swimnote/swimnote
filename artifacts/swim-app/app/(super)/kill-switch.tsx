              ...
              <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                <View style={m.confirmInfo}>
                  <Text style={m.confirmInfoTxt}>
                    대상: <Text style={{ fontFamily: "Pretendard-SemiBold", color: DANGER }}>{poolName}</Text>{"\n"}
...
const s = StyleSheet.create({
  ...
  tabTxtActive: { color: DANGER, fontFamily: "Pretendard-SemiBold" },
  ...
  stepBadgeTxt: { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  stepTitle:    { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#0F172A", flex: 1 },
  ...
  reasonLabel:  { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  modeLabel:    { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  queueName:    { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  queueTimer:   { fontSize: 12, fontFamily: "Pretendard-Medium", marginTop: 2 },
  ...
  deferTxt:     { fontSize: 11, fontFamily: "Pretendard-Medium", color: WARN },
  cancelScheduleBtn: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: "#FFFFFF" },
  cancelScheduleTxt: { fontSize: 11, fontFamily: "Pretendard-Medium", color: "#64748B" },
  termBtn:      { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: "#2EC4B6" },
  termTxt:      { fontSize: 11, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  logLeft:      { width: 28, height: 28, borderRadius: 8, backgroundColor: "#F9DEDA",
                  alignItems: "center", justifyContent: "center" },
  logTitle:     { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
...
const m = StyleSheet.create({
  ...
  dangerHeaderTxt:{ fontSize: 16, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  safeTitle:      { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  snapshotBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
  snapshotDone:   { flexDirection: "row", alignItems: "center", gap: 8, padding: 10, borderRadius: 10, backgroundColor: "#E6FFFA" },
  snapshotDoneTxt:{ fontSize: 13, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
  ...
  confirmInput:   { borderWidth: 2, borderColor: DANGER, borderRadius: 10, padding: 12,
                    fontSize: 14, fontFamily: "Pretendard-SemiBold", color: DANGER },
  ...
  deleteTxt:      { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
});
