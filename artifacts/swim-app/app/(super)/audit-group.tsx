...
const s = StyleSheet.create({
  ...
  summaryNum:      { fontSize: 20, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  catTxt:          { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: "#2EC4B6" },
  ...
  viewAllTxt:      { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
