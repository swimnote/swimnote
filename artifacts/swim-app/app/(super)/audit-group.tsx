...
const s = StyleSheet.create({
  ...
  summaryNum:      { fontSize: 20, fontFamily: "Pretendard-Bold", color: "#111827" },
  summaryLabel:    { fontSize: 9, fontFamily: "Pretendard-Regular", color: "#6B7280", marginTop: 2, textAlign: "center" },
  ...
  catTxt:          { fontSize: 10, fontFamily: "Pretendard-Bold", color: "#2EC4B6" },
  ...
  viewAllTxt:      { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#2EC4B6" },
