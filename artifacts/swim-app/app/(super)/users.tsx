...
const ps = StyleSheet.create({
  ...
  permLabel:    { fontSize: 13, fontFamily: "Pretendard-Medium" },
...
const styles = StyleSheet.create({
  ...
  badge:           { fontSize: 12, fontFamily: "Pretendard-Medium", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  permSectionTitle:{ fontSize: 14, fontFamily: "Pretendard-Medium", marginBottom: 4 },
