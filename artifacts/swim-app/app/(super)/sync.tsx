...
const s = StyleSheet.create({
  ...
  runBtnTxt:      { color: "#fff", fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  pendingBadgeTxt:{ fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  tenantRow:      { flexDirection: "row", alignItems: "center", gap: 10, padding: 12 },
  tenantName:     { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
