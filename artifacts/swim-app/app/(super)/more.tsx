...
const s = StyleSheet.create({
  ...
  headerTitle:      { fontSize: 22, fontFamily: "Pretendard-SemiBold" },
  ...
  profileAvatarTxt: { fontSize: 22, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  profileName:      { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  securityBtnTxt:   { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#fff" },
  sectionLabel:     { fontSize: 12, fontFamily: "Pretendard-SemiBold", letterSpacing: 0.5, textTransform: "uppercase",
  ...
  otpBannerTitle:   { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
