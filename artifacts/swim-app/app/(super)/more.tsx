...
const s = StyleSheet.create({
  ...
  profileAvatarTxt: { fontSize: 22, fontFamily: "Pretendard-Bold", color: "#fff" },
  profileName:      { fontSize: 18, fontFamily: "Pretendard-Bold", color: "#fff" },
  ...
  securityBtnTxt:   { fontSize: 12, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  sectionLabel:     { fontSize: 12, fontFamily: "Pretendard-Bold", letterSpacing: 0.5, textTransform: "uppercase",
  ...
  menuLabel:        { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  otpBannerTitle:   { fontSize: 14, fontFamily: "Pretendard-Bold" },
