    ...
    <SafeAreaView style={s.safe} edges={["top"]}>
          ...
          <Pressable style={s.sheet} onPress={() => {}}>
            ...
            <View style={s.sheetBtns}>
              <Pressable style={[s.sheetBtn, { backgroundColor: "#FFFFFF" }]} onPress={() => setBulkModal(null)}>
                <Text style={{ color: "#0F172A", fontFamily: "Pretendard-Medium" }}>취소</Text>
              </Pressable>
              <Pressable style={[s.sheetBtn, { backgroundColor: BULK_ACTIONS.find(a => a.key === bulkModal)?.bg ?? "#FFFFFF" }]}
                ...
                <Text style={{ color: BULK_ACTIONS.find(a => a.key === bulkModal)?.color ?? "#0F172A", fontFamily: "Pretendard-Medium" }}>
                  확인
                </Text>
              </Pressable>
            </View>
      ...
      <View style={s.listHeader}>
        <Text style={s.listCount}>
          <Text style={{ color: filterChip.color, fontFamily: "Pretendard-SemiBold" }}>{sorted.length}</Text>
...
const s = StyleSheet.create({
  ...
  sheetTitle:        { fontFamily: "Pretendard-SemiBold", fontSize: 16, color: "#0F172A" },
  ...
  sortChipTxtActive: { color: P, fontFamily: "Pretendard-Medium" },
  ...
  bulkTxt:           { fontFamily: "Pretendard-Medium", fontSize: 11 },
  ...
  rowName:           { fontFamily: "Pretendard-SemiBold", fontSize: 15, color: "#0F172A", flex: 1 },
  badge:             { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  badgeTxt:          { fontFamily: "Pretendard-Medium", fontSize: 10 },
  ...
  storagePct:        { fontFamily: "Pretendard-Medium", fontSize: 11, minWidth: 34, textAlign: "right" },
  rowBottom:         { flexDirection: "row", alignItems: "center", gap: 4 },
  billingBadge:      { fontFamily: "Pretendard-Medium", fontSize: 11 },
  ...
  actTxt:            { fontFamily: "Pretendard-Medium", fontSize: 11 },
