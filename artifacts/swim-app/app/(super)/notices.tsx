...
const nc = StyleSheet.create({
  ...
  latestTxt:    { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: "#2EC4B6" },
  typeBadge:    { flexDirection: "row", alignItems: "center", gap: 3, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 7 },
  typeTxt:      { fontSize: 10, fontFamily: "Pretendard-SemiBold" },
  ...
  targetTxt:    { fontSize: 11, fontFamily: "Pretendard-SemiBold" },
