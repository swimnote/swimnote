...
const nc = StyleSheet.create({
  ...
  latestTxt:    { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
  typeBadge:    { flexDirection: "row", alignItems: "center", gap: 3, paddingHorizontal: 7, paddingVertical: 3, borderRadius: 7 },
  typeTxt:      { fontSize: 10, fontFamily: "Pretendard-Medium" },
  ...
  targetTxt:    { fontSize: 11, fontFamily: "Pretendard-Medium" },
  ...
  forcedTxt:    { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#D96C6C" },
  date:         { fontSize: 11, fontFamily: "Pretendard-Regular", color: "#64748B", marginLeft: "auto" },
  title:        { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A", marginBottom: 4 },
...
const s = StyleSheet.create({
  ...
  filterTxt:    { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#64748B" },
  filterActiveTxt: { color: "#fff" },
  addBtn:       { flexDirection: "row", alignItems: "center", gap: 4, backgroundColor: P,
                  paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8 },
  addTxt:       { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#fff" },
...
const m = StyleSheet.create({
  ...
  label:        { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#0F172A", marginBottom: 4, marginTop: 12 },
