...
const pc = StyleSheet.create({
  ...
  tierTxt:     { fontSize: 10, fontFamily: "Pretendard-SemiBold", color: P },
  name:        { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A", flex: 1 },
  price:       { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: G },
  ...
  infoVal:     { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#0F172A", marginTop: 2 },
...
const ep = StyleSheet.create({
  ...
  name:        { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  size:        { fontSize: 13, fontFamily: "Pretendard-Medium", color: G, marginTop: 2 },
  price:       { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
...
const fm = StyleSheet.create({
  ...
  close:         { padding: 4 },
  title:         { flex: 1, textAlign: "center", fontSize: 16, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  saveTxt:       { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  label:         { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#0F172A", marginBottom: 6 },
...
const s = StyleSheet.create({
  ...
  tabTxt:           { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#64748B" },
  ...
  createBtnTxt:     { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  storageStatNum:   { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  sectionLabel:     { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
