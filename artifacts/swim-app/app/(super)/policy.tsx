...
const s = StyleSheet.create({
  ...
  subTabTxt:       { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#64748B" },
  ...
  policyTitle:     { flex: 1, fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  activeBadge:     { backgroundColor: "#E6FFFA", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  activeBadgeTxt:  { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#2EC4B6" },
  ...
  actionTxt:       { flex: 1, fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  addVerTxt:       { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  verBadgeTxt:     { fontSize: 11, fontFamily: "Pretendard-SemiBold", color: P },
  ...
  unsignedHeaderTxt:{ fontSize: 13, fontFamily: "Pretendard-Medium", color: "#D96C6C" },
  ...
  unsignedName:    { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#0F172A" },
