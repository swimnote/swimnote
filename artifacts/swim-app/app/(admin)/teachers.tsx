      ...
      <SubScreenHeader
        ...
        rightSlot={
          <Pressable style={[s.accountsBtn, { backgroundColor: C.tintLight }]} onPress={() => setShowAccounts(true)}>
            <LucideIcon name="users" size={15} color={C.tint} />
                    ...
                    <View style={{ flexDirection: "row", gap: 10, marginTop: 8 }}>
                      {[
                        ...
                        <View key={i} style={[s.statCard, { backgroundColor: C.card }]}>
                          <LucideIcon name={st.icon as any} size={18} color={st.color} />
                      ...
                      return (
                        <Pressable key={time} style={[s.timeCard, { backgroundColor: C.card }]}
                          ...
                          <View style={[s.timeBox, { backgroundColor: C.tintLight }]}>
                            <LucideIcon name="clock" size={14} color={C.tint} />
              ...
              {scheduleTab === "monthly" && nav.step === "main" && (
                <>
                  <View style={[s.hintRow, { backgroundColor: C.tintLight }]}>
                    <LucideIcon name="info" size={13} color={C.tint} />
...
const s = StyleSheet.create({
  ...
  accountsBtnText: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  tabBar: { flexDirection: "row", borderBottomWidth: 1 },
  tabItem: { flex: 1, alignItems: "center", paddingVertical: 12, borderBottomWidth: 2.5, borderBottomColor: "transparent" },
  tabLabel: { fontSize: 15, fontFamily: "Pretendard-Regular" },
  breadcrumb: { borderBottomWidth: 1 },
  crumb: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  sectionTitle: { fontSize: 16, fontFamily: "Pretendard-Regular", marginBottom: 2 },
  sectionSub: { fontSize: 13, fontFamily: "Pretendard-Regular", marginBottom: 8 },
  ...
  statLbl: { fontSize: 11, fontFamily: "Pretendard-Regular" },
  ...
  timeText: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  timeCardMain: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  timeCardSub: { fontSize: 12, fontFamily: "Pretendard-Regular" },
  ...
  classStat: { fontSize: 12, fontFamily: "Pretendard-Regular" },
  diaryBadge: { paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6 },
  diaryBadgeTxt: { fontSize: 10, fontFamily: "Pretendard-Regular" },
