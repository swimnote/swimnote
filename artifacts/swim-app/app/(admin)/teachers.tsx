...
const s = StyleSheet.create({
  ...
  accountsBtnText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  tabBar: { flexDirection: "row", borderBottomWidth: 1 },
  tabItem: { flex: 1, alignItems: "center", paddingVertical: 12, borderBottomWidth: 2.5, borderBottomColor: "transparent" },
  tabLabel: { fontSize: 15, fontFamily: "Pretendard-Medium" },
  breadcrumb: { borderBottomWidth: 1 },
  crumb: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  sectionTitle: { fontSize: 16, fontFamily: "Pretendard-SemiBold", marginBottom: 2 },
  ...
  statNum: { fontSize: 22, fontFamily: "Pretendard-SemiBold" },
  ...
  timeText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  timeCardMain: { fontSize: 14, fontFamily: "Pretendard-Medium" },
