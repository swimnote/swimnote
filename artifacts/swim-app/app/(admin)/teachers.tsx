...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontFamily: "Pretendard-Bold", marginBottom: 2 },
  ...
  timeText: { fontSize: 13, fontFamily: "Pretendard-Bold" },
  timeCardMain: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  diaryBadgeTxt: { fontSize: 10, fontFamily: "Pretendard-SemiBold" },
