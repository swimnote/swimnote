...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  ...
  nextBtnText: { color: "#fff", fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  selectAllText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  selectionText: { color: "#fff", fontSize: 14, fontFamily: "Pretendard-Medium" },
  selectionBtn: { paddingHorizontal: 14, paddingVertical: 6, backgroundColor: "rgba(255,255,255,0.2)", borderRadius: 10 },
  selectionBtnText: { color: "#fff", fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  sectionTitle: { fontSize: 13, fontFamily: "Pretendard-Medium", textTransform: "uppercase", letterSpacing: 0.3 },
  ...
  pickText: { fontSize: 16, fontFamily: "Pretendard-Medium" },
  ...
  addMoreText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  infoBox: { flexDirection: "row", alignItems: "flex-start", gap: 8 },
  infoText: { fontSize: 13, fontFamily: "Pretendard-Medium", lineHeight: 20, flex: 1 },
});
