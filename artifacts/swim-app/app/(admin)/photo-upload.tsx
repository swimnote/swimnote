...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  nextBtnText: { color: "#fff", fontSize: 14, fontFamily: "Pretendard-Bold" },
  ...
  selectionText: { color: "#fff", fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  selectionBtn: { paddingHorizontal: 14, paddingVertical: 6, backgroundColor: "rgba(255,255,255,0.2)", borderRadius: 10 },
  selectionBtnText: { color: "#fff", fontSize: 13, fontFamily: "Pretendard-Bold" },
  sectionTitle: { fontSize: 13, fontFamily: "Pretendard-SemiBold", textTransform: "uppercase", letterSpacing: 0.3 },
  ...
  pickText: { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
