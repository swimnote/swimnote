...
const s = StyleSheet.create({
  ...
  monthLabel: { fontSize: 16, fontFamily: "Pretendard-SemiBold", minWidth: 90, textAlign: "center" },
  holiBtn: { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 10, borderWidth: 1.5 },
  holiBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  quickLabel: { fontSize: 12, fontFamily: "Pretendard-Medium" },

  summaryCard: { borderRadius: 16, padding: 16, borderWidth: 1.5, backgroundColor: Colors.light.card, gap: 12 },
  summaryTop: { gap: 2 },
  summaryTitle: { fontSize: 12, fontFamily: "Pretendard-Medium" },
  summaryAmount: { fontSize: 24, fontFamily: "Pretendard-SemiBold" },
  summaryRow: { flexDirection: "row" },
  summaryItem: { flex: 1, alignItems: "center", gap: 2 },
  summaryItemLabel: { fontSize: 11, fontFamily: "Pretendard-Regular" },
  summaryItemVal: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },

  sectionTitle: { fontSize: 15, fontFamily: "Pretendard-SemiBold", marginTop: 4 },
  ...
  teacherCount:   { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  teacherName:    { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  teacherPos:     { fontSize: 12, fontFamily: "Pretendard-Regular", marginTop: 2 },
  teacherAmt:     { fontSize: 22, fontFamily: "Pretendard-SemiBold" },
  ...
  statBoxVal:     { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  ...
  actionBtnTxt: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  savedMsg: { textAlign: "center", fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  modalTitle: { fontSize: 18, fontFamily: "Pretendard-SemiBold", textAlign: "center" },
  modalDesc: { fontSize: 13, fontFamily: "Pretendard-Regular", textAlign: "center", lineHeight: 20 },
  modalBtns: { flexDirection: "row", gap: 10, marginTop: 4 },
  modalBtn: { flex: 1, paddingVertical: 13, borderRadius: 12, alignItems: "center" },
  modalBtnTxt: { fontSize: 15, fontFamily: "Pretendard-Medium" },
});
