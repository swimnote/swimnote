...
const s = StyleSheet.create({
  ...
  quickLabel: { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  ...
  summaryAmount: { fontSize: 24, fontFamily: "Pretendard-Bold" },
  summaryRow: { flexDirection: "row" },
  summaryItem: { flex: 1, alignItems: "center", gap: 2 },
  summaryItemLabel: { fontSize: 11, fontFamily: "Pretendard-Regular" },
  summaryItemVal: { fontSize: 14, fontFamily: "Pretendard-Bold" },

  sectionTitle: { fontSize: 15, fontFamily: "Pretendard-Bold", marginTop: 4 },
  ...
  teacherName:    { fontSize: 16, fontFamily: "Pretendard-Bold" },
  teacherPos:     { fontSize: 12, fontFamily: "Pretendard-Regular", marginTop: 2 },
  teacherAmt:     { fontSize: 22, fontFamily: "Pretendard-Bold" },
  ...
  actionBtnTxt: { fontSize: 14, fontFamily: "Pretendard-Bold", color: "#fff" },
  savedMsg: { textAlign: "center", fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  modalTitle: { fontSize: 18, fontFamily: "Pretendard-Bold", textAlign: "center" },
  modalDesc: { fontSize: 13, fontFamily: "Pretendard-Regular", textAlign: "center", lineHeight: 20 },
  modalBtns: { flexDirection: "row", gap: 10, marginTop: 4 },
  modalBtn: { flex: 1, paddingVertical: 13, borderRadius: 12, alignItems: "center" },
  modalBtnTxt: { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
});
