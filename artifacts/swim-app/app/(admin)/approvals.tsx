...
const styles = StyleSheet.create({
  ...
  section: { borderRadius: 8, borderWidth: 1, padding: 10, gap: 6 },
  ...
  rejectNote: { fontSize: 12, fontFamily: "Inter_400Regular", paddingVertical: 8 },
  actions: { flexDirection: "row", gap: 10 },
  rejectBtn: { flex: 1, flexDirection: "row", borderWidth: 1.5, borderRadius: 8, paddingVertical: 10, alignItems: "center", justifyContent: "center", gap: 6 },
  rejectText: { fontSize: 13, fontWeight: "600", fontFamily: "Inter_600SemiBold" },
  approveBtn: { flex: 1, flexDirection: "row", borderRadius: 8, paddingVertical: 10, alignItems: "center", justifyContent: "center", gap: 6 },
