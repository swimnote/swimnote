...
const styles = StyleSheet.create({
  ...
  card: { minHeight: 160, borderRadius: 12, padding: 16, gap: 12, backgroundColor: "#fff" },
  cardTop: { flexDirection: "row", alignItems: "flex-start", gap: 12, minHeight: 60 },
  ...
  section: { borderRadius: 8, borderWidth: 1, padding: 10, gap: 6, minHeight: 60 },
  sectionTitle: { fontSize: 12, fontWeight: "600", fontFamily: "Inter_600SemiBold" },
  childRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 6, minHeight: 18 },
  childName: { fontSize: 13, fontWeight: "500", fontFamily: "Inter_500Medium" },
  childBirth: { fontSize: 12, fontFamily: "Inter_400Regular" },
  rejectNote: { fontSize: 12, fontFamily: "Inter_400Regular", paddingVertical: 8, minHeight: 36 },
  actions: { flexDirection: "row", gap: 10, minHeight: 48 },
  rejectBtn: { flex: 1, flexDirection: "row", borderWidth: 1.5, borderRadius: 8, paddingVertical: 10, alignItems: "center", justifyContent: "center", gap: 6, height: 48 },
  rejectText: { fontSize: 13, fontWeight: "600", fontFamily: "Inter_600SemiBold" },
  approveBtn: { flex: 1, flexDirection: "row", borderRadius: 8, paddingVertical: 10, alignItems: "center", justifyContent: "center", gap: 6, height: 48 },
