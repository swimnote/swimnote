...
const styles = StyleSheet.create({
  ...
  selBtnText: { fontSize: 13, fontFamily: "Pretendard-Medium", color: Colors.light.textSecondary },
  ...
  sectionText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  noticeTitle: { fontSize: 15, fontFamily: "Pretendard-SemiBold", flex: 1 },
  noticeContent: { fontSize: 14, fontFamily: "Pretendard-Regular", lineHeight: 22 },
  thumbImage: { width: 130, height: 130, borderRadius: 10 },
  statsRow: { flexDirection: "row", alignItems: "center", gap: 12 },
  statItem: { flexDirection: "row", alignItems: "center", gap: 5 },
  statText: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  modalTitle: { fontSize: 20, fontFamily: "Pretendard-Bold" },
  errorText: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  textarea: { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, paddingTop: 12, height: 100, fontSize: 15, fontFamily: "Pretendard-Regular" },
  ...
  addImageText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  pinText: { fontSize: 14, fontFamily: "Pretendard-Medium" },
