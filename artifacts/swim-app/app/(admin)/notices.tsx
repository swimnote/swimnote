...
const styles = StyleSheet.create({
  ...
  sectionText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  noticeTitle: { fontSize: 15, fontFamily: "Pretendard-Medium", flex: 1 },
  ...
  statText: { fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  modalTitle: { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
