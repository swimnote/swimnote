...
const styles = StyleSheet.create({
  ...
  selBtnText: { fontSize: 13, fontFamily: "Pretendard-Regular", color: Colors.light.textSecondary },
  ...
  sectionText: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  noticeTitle: { fontSize: 15, fontFamily: "Pretendard-Regular", flex: 1 },
  ...
  modalTitle: { fontSize: 20, fontFamily: "Pretendard-Regular" },
  ...
  addImageText: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  pinText: { fontSize: 14, fontFamily: "Pretendard-Regular" },
