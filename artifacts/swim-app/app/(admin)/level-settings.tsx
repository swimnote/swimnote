...
const s = StyleSheet.create({
  ...
  saveBtnTxt: { fontSize: 14, fontFamily: "Pretendard-Regular" },
  infoCard: {
  ...
  sectionLabel: { fontSize: 14, fontFamily: "Pretendard-Regular", color: C.text, marginBottom: 10 },
  badgeTypeRow: { flexDirection: "row", gap: 8 },
  typeBtn: {
    flex: 1, paddingVertical: 8, alignItems: "center", borderRadius: 8,
    borderWidth: 1, borderColor: C.border,
  },
  typeBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.textSecondary },
  ...
  bottomSaveTxt: { fontSize: 16, fontFamily: "Pretendard-Regular", color: "#fff" },
});
