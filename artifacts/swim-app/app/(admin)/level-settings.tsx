...
const s = StyleSheet.create({
  ...
  saveBtnTxt: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  infoCard: {
  ...
  inactiveBadgeTxt: { fontSize: 10, fontFamily: "Pretendard-Medium", color: "#64748B" },
  activeToggle: {
  ...
  cardTitle: { fontSize: 15, fontFamily: "Pretendard-Medium", color: C.text },
  ...
  fieldLabel: { fontSize: 12, fontFamily: "Pretendard-Medium", color: C.textSecondary, marginBottom: 6 },
  input: {
  ...
  sectionLabel: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.text, marginBottom: 10 },
  badgeTypeRow: { flexDirection: "row", gap: 8 },
  typeBtn: {
    flex: 1, paddingVertical: 8, alignItems: "center", borderRadius: 8,
    borderWidth: 1, borderColor: C.border,
  },
  typeBtnTxt: { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  ...
  bottomSaveTxt: { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: "#fff" },
});
