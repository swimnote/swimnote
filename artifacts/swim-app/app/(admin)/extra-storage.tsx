      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 12, paddingBottom: 60 }}>
        ...
        <View style={s.card}>
          ...
          <View style={[s.row, { borderTopWidth: 1, borderTopColor: '#F8FAFC', paddingTop: 8, marginTop: 4 }]}>
            <Text style={[s.rowLabel, { fontFamily: 'Pretendard-Bold', color: '#111827' }]}>총 사용 가능</Text>
            <Text style={[s.rowVal, { fontFamily: 'Pretendard-Bold', color: '#111827' }]}>{fmtMb(totalMb)}</Text>
          </View>
        ...
        <View style={[s.card, { borderColor: videoUnlocked ? '#E6FFFA' : '#F9DEDA' }]}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[s.rowLabel, { color: videoUnlocked ? G : '#D96C6C', fontFamily: 'Pretendard-SemiBold' }]}>
...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, fontFamily: 'Pretendard-Bold', color: '#111827', marginBottom: 2 },
  row: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 4 },
  rowLabel: { fontSize: 13, fontFamily: 'Pretendard-Regular', color: '#6B7280' },
  rowVal: { fontSize: 13, fontFamily: 'Pretendard-SemiBold', color: '#111827' },
  ...
  prodName: { fontSize: 15, fontFamily: 'Pretendard-Bold', color: '#111827' },
  prodMb: { fontSize: 13, fontFamily: 'Pretendard-SemiBold', color: G, marginTop: 2 },
  prodNote: { fontSize: 11, fontFamily: 'Pretendard-Regular', color: '#6B7280', marginTop: 2, lineHeight: 15 },
  prodPrice: { fontSize: 16, fontFamily: 'Pretendard-Bold', color: '#111827' },
  ...
  primaryBtnTxt: { fontSize: 15, fontFamily: 'Pretendard-Bold', color: '#fff' },
  ...
  histName: { fontSize: 14, fontFamily: 'Pretendard-SemiBold', color: '#111827' },
  histSub: { fontSize: 12, fontFamily: 'Pretendard-Regular', color: '#9CA3AF', marginTop: 2 },
  histPrice: { fontSize: 14, fontFamily: 'Pretendard-Bold', color: '#111827' },
})
...
const m = StyleSheet.create({
  ...
  amount: { fontSize: 32, fontFamily: 'Pretendard-Bold', color: '#111827', textAlign: 'center' },
  price: { fontSize: 20, fontFamily: 'Pretendard-SemiBold', color: '#2EC4B6', textAlign: 'center' },
  ...
  cancelTxt: { fontSize: 15, fontFamily: 'Pretendard-SemiBold', color: '#6B7280' },
