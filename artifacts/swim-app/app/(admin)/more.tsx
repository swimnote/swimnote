...
const sm = StyleSheet.create({
  ...
  activeBadgeText: { fontSize: 12, fontFamily: "Pretendard-Medium" },
...
const s = StyleSheet.create({
  ...
  tabText:  { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  profileInitial: { fontSize: 20, fontFamily: "Pretendard-SemiBold" },
  profileName:    { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  ...
  switchBtnText:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  groupTitle: { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#64748B", marginBottom: 8, paddingHorizontal: 4 },
  ...
  menuLabel:  { fontSize: 15, fontFamily: "Pretendard-Medium", color: "#0F172A" },
  ...
  logName:       { fontSize: 15, fontFamily: "Pretendard-SemiBold", color: "#0F172A" },
  logAction:     { fontSize: 12, fontFamily: "Pretendard-Medium", marginTop: 1 },
  ...
  logValueLabel: { width: 50, fontSize: 12, fontFamily: "Pretendard-Medium", color: "#64748B" },
  logValue:      { flex: 1, fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  logActor:      { fontSize: 11, fontFamily: "Pretendard-Medium", color: "#64748B" },
  ...
  otpBannerTitle:{ fontSize: 13, fontFamily: "Pretendard-SemiBold" },
