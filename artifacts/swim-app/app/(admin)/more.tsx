...
const s = StyleSheet.create({
  ...
  profileName:    { fontSize: 18, fontFamily: "Pretendard-Bold", color: "#0F172A" },
  ...
  groupTitle: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: "#64748B", marginBottom: 8, paddingHorizontal: 4 },
  ...
  logName:       { fontSize: 15, fontFamily: "Pretendard-Bold", color: "#0F172A" },
