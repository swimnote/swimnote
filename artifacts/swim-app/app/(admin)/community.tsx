...
const s = StyleSheet.create({
  ...
  tabBadge: { fontSize: 13, fontFamily: "Pretendard-Bold" },
  ...
  emptyBtnText: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  typeBadgeText: { fontSize: 11, fontFamily: "Pretendard-SemiBold" },
  noticeDate: { marginLeft: "auto", fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textMuted },
  noticeTitle: { fontSize: 16, fontFamily: "Pretendard-Bold", color: C.text },
  ...
  reqBtnText: { fontSize: 14, fontFamily: "Pretendard-Bold" },
});
