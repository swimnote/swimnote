...
const s = StyleSheet.create({
  ...
  tabBadge: { fontSize: 13, fontFamily: "Pretendard-SemiBold" },
  ...
  emptyBtnText: { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  typeBadgeText: { fontSize: 11, fontFamily: "Pretendard-Medium" },
  noticeDate: { marginLeft: "auto", fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textMuted },
  noticeTitle: { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  reqParent: { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  childNames: { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: C.text, flex: 1 },
  memoRow: { flexDirection: "row", alignItems: "flex-start", gap: 6, paddingHorizontal: 4 },
  memoText: { fontSize: 12, fontFamily: "Pretendard-Regular", color: C.textSecondary, flex: 1 },
  ...
  reqBtnText: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
});
