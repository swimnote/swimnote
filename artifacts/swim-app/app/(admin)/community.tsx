...
const s = StyleSheet.create({
  ...
  tabBadge: { fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  reqParent: { fontSize: 16, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  childNames: { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.text, flex: 1 },
  ...
  reqBtnText: { fontSize: 14, fontFamily: "Pretendard-Regular" },
});
