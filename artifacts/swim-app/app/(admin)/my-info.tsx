...
const s = StyleSheet.create({
  ...
  cardTitle: { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.text },
  avatar: { width: 52, height: 52, borderRadius: 16, alignItems: "center", justifyContent: "center" },
  avatarText: { fontSize: 22, fontFamily: "Pretendard-Bold" },
  profileName: { fontSize: 18, fontFamily: "Pretendard-Bold", color: C.text },
  ...
  editBtnText: { fontSize: 12, fontFamily: "Pretendard-SemiBold" },
