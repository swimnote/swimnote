...
const s = StyleSheet.create({
  ...
  inputLabel: { fontSize: 13, fontFamily: "Inter_500Medium", color: C.textSecondary, marginTop: 6 },
  input: { borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, height: 46, fontSize: 15, fontFamily: "Inter_400Regular", marginTop: 4 },
