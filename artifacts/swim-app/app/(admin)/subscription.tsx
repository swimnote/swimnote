...
// 2026-08-28 가격 재설계: 신규가입 가능 플랜만 노출
// Coach30 / Coach50 / Premier200 → deprecated (기존 구독자 보호, 신규가입 불가)
const SOLO_PLANS: PlanMeta[] = [
  { tier: "free",     name: "Free",  price: 0,    limit: 10,  storage: "100MB", storageMb: 102,  group: "solo", rcPackageId: null },
  { tier: "standard", name: "SOLO",  price: 4900, limit: 100, storage: "1GB",   storageMb: 1024, group: "solo", rcPackageId: "solo_100", recommended: true },
];

const CENTER_PLANS: PlanMeta[] = [
  { tier: "advance", name: "Premier 300",  price: 11900, limit: 300,  storage: "10GB", storageMb: 10240, group: "center", rcPackageId: "center_300" },
  { tier: "pro",     name: "Premier 500",  price: 19900, limit: 500,  storage: "20GB", storageMb: 20480, group: "center", rcPackageId: "center_500" },
  { tier: "max",     name: "Premier 1000", price: 29900, limit: 1000, storage: "50GB", storageMb: 51200, group: "center", rcPackageId: "center_1000", recommended: true },
];
