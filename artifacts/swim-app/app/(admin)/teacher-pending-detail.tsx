...
const s = StyleSheet.create({
  ...
  statusBannerTxt:   { fontSize: 16, fontFamily: "Pretendard-Bold" },
  ...
  sectionTitle:      { fontSize: 13, fontFamily: "Pretendard-SemiBold", color: C.textSecondary, textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  statValue:         { fontSize: 24, fontFamily: "Pretendard-Bold" },
  ...
  roleLabel:         { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.text, marginBottom: 2 },
  ...
  errorTitle:        { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  backBtnTxt:        { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  modalCancelTxt:    { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  modalRejectBtn:    { flex: 1, height: 50, borderRadius: 12, backgroundColor: "#D96C6C", alignItems: "center", justifyContent: "center" },
  modalRejectTxt:    { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: "#fff" },
  ...
  reasonTitle:       { fontSize: 18, fontFamily: "Pretendard-Bold", color: C.text },
  ...
  reasonCloseTxt:    { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
});
