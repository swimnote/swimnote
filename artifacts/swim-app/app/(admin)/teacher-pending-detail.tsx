...
const s = StyleSheet.create({
  ...
  statusBannerTxt:   { fontSize: 16, fontFamily: "Pretendard-Regular" },
  ...
  infoLabel:         { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.textSecondary, width: 72 },
  ...
  errorTitle:        { fontSize: 17, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  backBtnTxt:        { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#fff" },
  ...
  modalCancelTxt:    { fontSize: 14, fontFamily: "Pretendard-Regular" },
  modalRejectBtn:    { flex: 1, height: 50, borderRadius: 12, backgroundColor: "#D96C6C", alignItems: "center", justifyContent: "center" },
  modalRejectTxt:    { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#fff" },
  ...
  reasonTitle:       { fontSize: 18, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  reasonCloseTxt:    { fontSize: 15, fontFamily: "Pretendard-Regular" },
});
