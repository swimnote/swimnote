          ...
          <View style={[styles.section, { backgroundColor: C.card, borderColor: C.border }]}>
            ...
            <View style={[styles.preview, { backgroundColor: C.background, borderColor: C.border }]}>
              ...
              <View style={[styles.previewNote, { backgroundColor: settings.hide_platform_name ? "#FFF7ED" : "#F0FDF4", borderColor: settings.hide_platform_name ? "#FED7AA" : "#BBF7D0" }]}>
                ...
                <Text style={{ fontSize: 12, fontFamily: "Inter_500Medium", color: settings.hide_platform_name ? "#C2410C" : "#15803D" }}>
...
const styles = StyleSheet.create({
  ...
  descBody: { fontSize: 13, fontFamily: "Inter_400Regular", lineHeight: 19 },
  poolChip: { flexDirection: "row", alignItems: "center", gap: 8, padding: 12, borderRadius: 12, borderWidth: 1 },
  poolChipTxt: { fontSize: 12, fontFamily: "Inter_400Regular" },
  poolChipName: { fontSize: 14, fontFamily: "Inter_700Bold", flex: 1 },
  section: { borderRadius: 16, borderWidth: 1, overflow: "hidden" },
  sectionTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", letterSpacing: 0.4, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 10, textTransform: "uppercase" },
