                  ...
                  <View style={[s.dayBox, {
                    ...
                    {isSaving ? (
                      ...
                      <Text style={[s.dayNum, {
                        ...
                        fontFamily: isHol ? "Pretendard-SemiBold" : "Pretendard-Regular",
                      }]}>{d}</Text>
                    )}
...
const s = StyleSheet.create({
  ...
  monthText:   { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  weekLabel:   { width: "14.28%" as any, textAlign: "center", fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  listTitle:   { fontSize: 15, fontFamily: "Pretendard-SemiBold" },
  ...
  holidayDate: { fontSize: 14, fontFamily: "Pretendard-Medium" },
  ...
  modalDate:   { fontSize: 16, fontFamily: "Pretendard-Medium" },
  ...
  modalBtnText:{ color: "#fff", fontSize: 15, fontFamily: "Pretendard-Medium" },
});
