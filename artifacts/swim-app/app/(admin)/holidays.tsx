...
const s = StyleSheet.create({
  ...
  weekLabel:   { width: "14.28%" as any, textAlign: "center", fontSize: 12, fontFamily: "Pretendard-SemiBold" },
  ...
  listTitle:   { fontSize: 15, fontFamily: "Pretendard-Bold" },
  ...
  holidayDate: { fontSize: 14, fontFamily: "Pretendard-SemiBold" },
  ...
  modalDate:   { fontSize: 16, fontFamily: "Pretendard-SemiBold" },
  ...
  modalBtnText:{ color: "#fff", fontSize: 15, fontFamily: "Pretendard-SemiBold" },
});
