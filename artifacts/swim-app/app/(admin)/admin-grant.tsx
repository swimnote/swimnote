...
const s = StyleSheet.create({
  ...
  emptyTxt:      { fontSize: 15, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  ...
  avatarTxt:     { fontSize: 17, fontFamily: "Pretendard-SemiBold" },
  nameRow:       { flexDirection: "row", alignItems: "center", gap: 6, flexWrap: "wrap" },
  name:          { fontSize: 14, fontFamily: "Pretendard-Medium", color: C.text },
  adminBadge:    { flexDirection: "row", alignItems: "center", gap: 3, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, borderWidth: 1 },
  adminBadgeTxt: { fontSize: 10, fontFamily: "Pretendard-Medium" },
  ...
  grantBtnTxt:   { fontSize: 12, fontFamily: "Pretendard-Medium", color: "#fff" },
  ...
  dialogTitle:   { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text, textAlign: "center" },
  ...
  dialogBtnCancelTxt:{ fontSize: 14, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  dialogBtnRevoke:   { backgroundColor: "#D96C6C" },
  dialogBtnTxt:  { fontSize: 14, fontFamily: "Pretendard-Medium", color: "#fff" },
});
