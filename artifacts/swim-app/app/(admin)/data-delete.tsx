            ...
            <View style={{ gap: 12, marginTop: 12 }}>
              <View style={s.previewCard}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 14 }}>
                  ...
                  <Text style={{ fontSize: 14, fontFamily: "Pretendard-Medium", color: "#D96C6C" }}>
...
const s = StyleSheet.create({
  ...
  sectionTitle:  { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  menuLabel:    { fontSize: 15, fontFamily: "Pretendard-Medium", color: C.text },
  ...
  chipText:     { fontSize: 11, fontFamily: "Pretendard-Medium", color: C.textSecondary },
  ...
  stepLabel:    { fontSize: 13, fontFamily: "Pretendard-Medium", color: "#64748B" },
  ...
  previewValue: { fontSize: 16, fontFamily: "Pretendard-SemiBold", color: "#D96C6C" },
  ...
  resultMsg: { fontSize: 16, fontFamily: "Pretendard-SemiBold", textAlign: "center", paddingHorizontal: 16 },
});
