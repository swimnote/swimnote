...
const KS_TYPES = [
  { key: "photo",  label: "사진",      icon: "image"     as const, color: "#F97316", bg: "#FFF1E8" },
  { key: "video",  label: "영상",      icon: "video"     as const, color: "#F97316", bg: "#FFF1E8" },
  { key: "record", label: "기록/일지", icon: "book-open" as const, color: "#2EC4B6", bg: "#E6FAF8" },
];
...
const RETENTION_TYPES = [
  ...
  { key: "video",     label: "영상",       icon: "video"      as const, color: "#F97316", bg: "#FFF1E8" },
  { key: "record",    label: "기록/일지",  icon: "book-open"  as const, color: "#2EC4B6", bg: "#E6FAF8" },
  { key: "messenger", label: "메신저",     icon: "message-square" as const, color: "#1B4965", bg: "#E8EEF4" },
];
