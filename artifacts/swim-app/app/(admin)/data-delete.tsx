            ...
            <View style={{ gap: 12, marginTop: 12 }}>
              <View style={s.previewCard}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 14 }}>
                  ...
                  <Text style={{ fontSize: 14, fontFamily: "Pretendard-Regular", color: "#D96C6C" }}>
...
const s = StyleSheet.create({
  ...
  sectionTitle:  { fontSize: 16, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  saveBtnText: { fontSize: 14, fontFamily: "Pretendard-Regular", color: "#fff" },
