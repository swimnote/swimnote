...
const s = StyleSheet.create({
  ...
  chip:      { height: 80, paddingHorizontal: 14, justifyContent: "center", alignItems: "center", borderRadius: 20, borderWidth: 1.5, borderColor: C.border, backgroundColor: "#fff", flexShrink: 0 },
  chipTxt:   { fontSize: 13, fontWeight: "600", color: C.textSecondary, lineHeight: 18 }, // WP5 · height×2.5 (32→80) · 0904
