...
const s = StyleSheet.create({
  ...
  chip:      { height: 40, paddingHorizontal: 16, justifyContent: "center", alignItems: "center", borderRadius: 20, borderWidth: 1.5, borderColor: C.textMuted, backgroundColor: "#fff", flexShrink: 0 },
  chipTxt:   { fontSize: 13, fontWeight: "600", color: C.text, lineHeight: 18 }, // WP5 FIX-3 · explicit height:40 on chip · 0904
