...
const s = StyleSheet.create({
  ...
  chip:      { height: 40, paddingHorizontal: 12, justifyContent: "center", alignItems: "center", borderRadius: 20, borderWidth: 1.5, borderColor: C.textMuted, backgroundColor: "#fff", flexShrink: 0 },
  chipTxt:   { fontSize: 13, fontWeight: "600", color: C.text, lineHeight: 18 }, // WP5 FIX-6 · height:40 restored · pH:12 compact · 0904
