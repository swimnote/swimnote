...
const s = StyleSheet.create({
  ...
  chip:      { paddingHorizontal: 12, paddingVertical: 6, justifyContent: "center", alignItems: "center", borderRadius: 20, borderWidth: 1.5, borderColor: C.border, backgroundColor: "#fff", flexShrink: 0 },
  chipTxt:   { fontSize: 13, fontWeight: "600", color: C.textSecondary, lineHeight: 18 }, // WP5 · communication.tsx ref · 0904
