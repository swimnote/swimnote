...
const mc = StyleSheet.create({
  ...
  monthTitle:     { fontSize: 17, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  timePillText:   { fontSize: 9, fontFamily: "Pretendard-Medium" },
  ...
  holidayTag:     { fontSize: 9, fontFamily: "Pretendard-SemiBold", color: "#D96C6C", marginTop: 2 },
});
...
const dy = StyleSheet.create({
  ...
  dateTitle:      { fontSize: 18, fontFamily: "Pretendard-SemiBold", color: C.text },
  ...
  classTime:      { fontSize: 14, fontFamily: "Pretendard-SemiBold", color: C.text },
...
const s = StyleSheet.create({
  ...
  iconBtnTxt:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  ...
  mgmtBtnTxt:  { fontSize: 12, fontFamily: "Pretendard-Medium" },
  createBtn:   { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10 },
  createBtnTxt:{ color: "#fff", fontSize: 13, fontFamily: "Pretendard-Medium" },
  ...
  toggleText:  { fontSize: 13, fontFamily: "Pretendard-Medium", color: C.textSecondary },
