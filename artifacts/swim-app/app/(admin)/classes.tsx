...
const s = StyleSheet.create({
  ...
  iconBtnTxt:  { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  ...
  mgmtBtnTxt:  { fontSize: 12, fontFamily: "Inter_600SemiBold" },
  createBtn:   { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10 },
  createBtnTxt:{ color: "#fff", fontSize: 13, fontFamily: "Inter_600SemiBold" },
