...
const dy = StyleSheet.create({
  ...
  dateTitle:      { fontSize: 18, fontFamily: "Pretendard-Regular", color: C.text },
  ...
  className:      { fontSize: 14, fontFamily: "Pretendard-Regular", color: C.text, flex: 1 },
...
const s = StyleSheet.create({
  ...
  iconBtnTxt:  { fontSize: 12, fontFamily: "Pretendard-Regular" },
  ...
  mgmtBtnTxt:  { fontSize: 12, fontFamily: "Pretendard-Regular" },
  createBtn:   { flexDirection: "row", alignItems: "center", gap: 5, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10 },
  createBtnTxt:{ color: "#fff", fontSize: 13, fontFamily: "Pretendard-Regular" },
  ...
  toggleText:  { fontSize: 13, fontFamily: "Pretendard-Regular", color: C.textSecondary },
