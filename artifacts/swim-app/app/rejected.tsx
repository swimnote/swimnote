...
const styles = StyleSheet.create({
  ...
  reasonLabel: { fontSize: 12, fontFamily: "Inter_600SemiBold", textTransform: "uppercase", letterSpacing: 0.5 },
  reasonText: { fontSize: 15, fontFamily: "Inter_400Regular", lineHeight: 22 },
  reapplyBtn: { paddingVertical: 14, paddingHorizontal: 32, borderRadius: 14, alignItems: "center" },
  reapplyText: { color: "#fff", fontSize: 16, fontFamily: "Inter_600SemiBold" },
