...
const styles = StyleSheet.create({
  ...
  reasonLabel: { fontSize: 12, fontFamily: "Pretendard-Medium", textTransform: "uppercase", letterSpacing: 0.5 },
  ...
  reapplyText: { color: "#fff", fontSize: 16, fontFamily: "Pretendard-Medium" },
