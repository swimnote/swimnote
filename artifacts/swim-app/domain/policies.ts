// domain/policies.ts — 플랜/가격/용량/사진 정책 (고정 기준)
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    ...
    isActive: true,
    isArchived: false,
    note: '정상+연기 회원 10명 / 500MB / 저화질 사진만 노출',
  ...
  },
  {
    ...
    isActive: true,
    isArchived: false,
    note: '회원 100명 / 10GB / 선명 사진 노출 / 영상은 추가용량 구매 시 활성',
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2024-01-01T00:00:00Z',
  },
  {
